...
def log_action(action, cron=None, fluff=None, mission=None, missionState=None, case=None, caseSolved=None, cronDocument=None, cronDocumentInstance=None, cronDocumentInstanceCorrect=None, message=None, successfulHack=None, mop=None, mail=None, mopDocumentInstance=None, mopDocumentInstanceCorrect=None, requisitionInstance=None, tutorialProgress=None):
    ActionLog.objects.create(action=action, cron=cron, fluff=fluff, mission=mission, missionState=missionState, case=case, caseSolved=caseSolved, cronDocument=cronDocument, cronDocumentInstance=cronDocumentInstance, cronDocumentInstanceCorrect=cronDocumentInstanceCorrect, message=message, successfulHack=successfulHack, mop=mop, mail=mail, mopDocumentInstance=mopDocumentInstance, mopDocumentInstanceCorrect=mopDocumentInstanceCorrect, requisitionInstance=requisitionInstance, tutorialProgress=tutorialProgress)
