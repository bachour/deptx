...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProvLog.state'
        db.delete_column(u'logger_provlog', 'state')

        # Adding field 'ProvLog.selected'
        db.add_column(u'logger_provlog', 'selected',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProvLog.state'
        db.add_column(u'logger_provlog', 'state',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ProvLog.selected'
        db.delete_column(u'logger_provlog', 'selected')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'d4d12bc0-56c8-11e3-9fd5'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        u'players.mop': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'d4d08d45-56c8-11e3-aaf7'", 'max_length': '36'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'}),
