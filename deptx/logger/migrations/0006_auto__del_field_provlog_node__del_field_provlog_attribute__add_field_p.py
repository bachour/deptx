...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProvLog.node'
        db.delete_column(u'logger_provlog', 'node')

        # Deleting field 'ProvLog.attribute'
        db.delete_column(u'logger_provlog', 'attribute')

        # Adding field 'ProvLog.node1'
        db.add_column(u'logger_provlog', 'node1',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProvLog.node2'
        db.add_column(u'logger_provlog', 'node2',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProvLog.attribute1'
        db.add_column(u'logger_provlog', 'attribute1',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProvLog.attribute2'
        db.add_column(u'logger_provlog', 'attribute2',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProvLog.empty'
        db.add_column(u'logger_provlog', 'empty',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'ProvLog.selected'
        db.alter_column(u'logger_provlog', 'selected', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'ProvLog.correct'
        db.alter_column(u'logger_provlog', 'correct', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):
        # Adding field 'ProvLog.node'
        db.add_column(u'logger_provlog', 'node',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProvLog.attribute'
        db.add_column(u'logger_provlog', 'attribute',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ProvLog.node1'
        db.delete_column(u'logger_provlog', 'node1')

        # Deleting field 'ProvLog.node2'
        db.delete_column(u'logger_provlog', 'node2')

        # Deleting field 'ProvLog.attribute1'
        db.delete_column(u'logger_provlog', 'attribute1')

        # Deleting field 'ProvLog.attribute2'
        db.delete_column(u'logger_provlog', 'attribute2')

        # Deleting field 'ProvLog.empty'
        db.delete_column(u'logger_provlog', 'empty')


        # Changing field 'ProvLog.selected'
        db.alter_column(u'logger_provlog', 'selected', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'ProvLog.correct'
        db.alter_column(u'logger_provlog', 'correct', self.gf('django.db.models.fields.NullBooleanField')(null=True))
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'16a27499-56ca-11e3-9560'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        u'players.mop': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'16a1b00a-56ca-11e3-8f60'", 'max_length': '36'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'}),
