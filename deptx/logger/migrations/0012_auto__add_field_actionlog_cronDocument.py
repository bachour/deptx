...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActionLog.cronDocument'
        db.add_column(u'logger_actionlog', 'cronDocument',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.CronDocument'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActionLog.cronDocument'
        db.delete_column(u'logger_actionlog', 'cronDocument_id')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'72ecfcba-5b76-11e3-a188'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
