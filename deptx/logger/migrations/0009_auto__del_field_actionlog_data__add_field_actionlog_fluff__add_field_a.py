...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ActionLog.data'
        db.delete_column(u'logger_actionlog', 'data')

        # Adding field 'ActionLog.fluff'
        db.add_column(u'logger_actionlog', 'fluff',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionLog.mission'
        db.add_column(u'logger_actionlog', 'mission',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.Mission'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionLog.missionState'
        db.add_column(u'logger_actionlog', 'missionState',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionLog.case'
        db.add_column(u'logger_actionlog', 'case',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.Case'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionLog.caseSolved'
        db.add_column(u'logger_actionlog', 'caseSolved',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionLog.cronDocumentInstance'
        db.add_column(u'logger_actionlog', 'cronDocumentInstance',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cron.CronDocumentInstance'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionLog.cronDocumentInstanceCorrect'
        db.add_column(u'logger_actionlog', 'cronDocumentInstanceCorrect',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionLog.message'
        db.add_column(u'logger_actionlog', 'message',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cron.HelpMail'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionLog.succesfulHack'
        db.add_column(u'logger_actionlog', 'succesfulHack',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionLog.mail'
        db.add_column(u'logger_actionlog', 'mail',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mop.Mail'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionLog.requisition'
        db.add_column(u'logger_actionlog', 'requisition',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.Requisition'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionLog.mopDocumentInstance'
        db.add_column(u'logger_actionlog', 'mopDocumentInstance',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mop.MopDocumentInstance'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionLog.mopDocumentInstanceCorrect'
        db.add_column(u'logger_actionlog', 'mopDocumentInstanceCorrect',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionLog.requisitionInstance'
        db.add_column(u'logger_actionlog', 'requisitionInstance',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mop.RequisitionInstance'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionLog.bodyType'
        db.add_column(u'logger_actionlog', 'bodyType',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionLog.tutorialProgress'
        db.add_column(u'logger_actionlog', 'tutorialProgress',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionLog.snapshot'
        db.add_column(u'logger_actionlog', 'snapshot',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ActionLog.data'
        raise RuntimeError("Cannot reverse this migration. 'ActionLog.data' and its values cannot be restored.")
        # Deleting field 'ActionLog.fluff'
        db.delete_column(u'logger_actionlog', 'fluff')

        # Deleting field 'ActionLog.mission'
        db.delete_column(u'logger_actionlog', 'mission_id')

        # Deleting field 'ActionLog.missionState'
        db.delete_column(u'logger_actionlog', 'missionState')

        # Deleting field 'ActionLog.case'
        db.delete_column(u'logger_actionlog', 'case_id')

        # Deleting field 'ActionLog.caseSolved'
        db.delete_column(u'logger_actionlog', 'caseSolved')

        # Deleting field 'ActionLog.cronDocumentInstance'
        db.delete_column(u'logger_actionlog', 'cronDocumentInstance_id')

        # Deleting field 'ActionLog.cronDocumentInstanceCorrect'
        db.delete_column(u'logger_actionlog', 'cronDocumentInstanceCorrect')

        # Deleting field 'ActionLog.message'
        db.delete_column(u'logger_actionlog', 'message_id')

        # Deleting field 'ActionLog.succesfulHack'
        db.delete_column(u'logger_actionlog', 'succesfulHack')

        # Deleting field 'ActionLog.mail'
        db.delete_column(u'logger_actionlog', 'mail_id')

        # Deleting field 'ActionLog.requisition'
        db.delete_column(u'logger_actionlog', 'requisition_id')

        # Deleting field 'ActionLog.mopDocumentInstance'
        db.delete_column(u'logger_actionlog', 'mopDocumentInstance_id')

        # Deleting field 'ActionLog.mopDocumentInstanceCorrect'
        db.delete_column(u'logger_actionlog', 'mopDocumentInstanceCorrect')

        # Deleting field 'ActionLog.requisitionInstance'
        db.delete_column(u'logger_actionlog', 'requisitionInstance_id')

        # Deleting field 'ActionLog.bodyType'
        db.delete_column(u'logger_actionlog', 'bodyType')

        # Deleting field 'ActionLog.tutorialProgress'
        db.delete_column(u'logger_actionlog', 'tutorialProgress')

        # Deleting field 'ActionLog.snapshot'
        db.delete_column(u'logger_actionlog', 'snapshot')
    ...
    models = {
        ...
        u'cron.helpmail': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'subject': ('django.db.models.fields.IntegerField', [], {}),
        ...
        u'logger.actionlog': {
            ...
            'requisition': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assets.Requisition']", 'null': 'True', 'blank': 'True'}),
            ...
            'succesfulHack': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'mop.mail': {
            ...
            'requisitionInstance': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mop.RequisitionInstance']", 'null': 'True', 'blank': 'True'}),
            'sentAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 1, 0, 0)'}),
            'serial': ('django.db.models.fields.CharField', [], {'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'0ec56382-5aa0-11e3-93c3'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
