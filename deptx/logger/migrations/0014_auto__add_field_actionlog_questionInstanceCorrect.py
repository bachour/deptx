...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActionLog.questionInstanceCorrect'
        db.add_column(u'logger_actionlog', 'questionInstanceCorrect',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActionLog.questionInstanceCorrect'
        db.delete_column(u'logger_actionlog', 'questionInstanceCorrect')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'a0dd74e3-6100-11e3-afa2'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
