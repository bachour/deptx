...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActionLog.caseDocumentsSolved'
        db.add_column(u'logger_actionlog', 'caseDocumentsSolved',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionLog.caseQuestionsSolved'
        db.add_column(u'logger_actionlog', 'caseQuestionsSolved',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionLog.questionInstance'
        db.add_column(u'logger_actionlog', 'questionInstance',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cron.CaseQuestionInstance'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionLog.data'
        db.add_column(u'logger_actionlog', 'data',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActionLog.caseDocumentsSolved'
        db.delete_column(u'logger_actionlog', 'caseDocumentsSolved')

        # Deleting field 'ActionLog.caseQuestionsSolved'
        db.delete_column(u'logger_actionlog', 'caseQuestionsSolved')

        # Deleting field 'ActionLog.questionInstance'
        db.delete_column(u'logger_actionlog', 'questionInstance_id')
    ...
    models = {
        ...
        u'mop.mail': {
            ...
            'requisitionInstance': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mop.RequisitionInstance']", 'null': 'True', 'blank': 'True'}),
            'sentAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 9, 0, 0)'}),
            'serial': ('django.db.models.fields.CharField', [], {'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'b72605ab-60fd-11e3-9bad'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
