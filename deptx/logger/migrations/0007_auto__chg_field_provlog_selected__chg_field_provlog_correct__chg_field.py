...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProvLog.empty'
        db.alter_column(u'logger_provlog', 'empty', self.gf('django.db.models.fields.NullBooleanField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ProvLog.empty'
        db.alter_column(u'logger_provlog', 'empty', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'4cd9d057-56ca-11e3-8f60'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        u'players.mop': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'4cd92126-56ca-11e3-81e7'", 'max_length': '36'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'}),
