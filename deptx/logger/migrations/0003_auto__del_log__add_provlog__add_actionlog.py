...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProvLog'
        db.create_table(u'logger_provlog', (
            ...
            ('cronDocumentInstance', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cron.CronDocumentInstance'], null=True, blank=True)),
            ('mopDocumentInstance', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mop.MopDocumentInstance'], null=True, blank=True)),
            ('action', self.gf('django.db.models.fields.IntegerField')()),
            ('node', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
        ...
        db.send_create_signal(u'logger', ['ProvLog'])

        # Adding model 'ActionLog'
        db.create_table(u'logger_actionlog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('createdAt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modifiedAt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
        ...
        db.send_create_signal(u'logger', ['ActionLog'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ProvLog'
        db.delete_table(u'logger_provlog')

        # Deleting model 'ActionLog'
        db.delete_table(u'logger_actionlog')
    ...
    models = {
        ...
        u'logger.provlog': {
            ...
            'node': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'6a6eb4cc-56c2-11e3-a742'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        u'players.mop': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'6a6e1526-56c2-11e3-b7b0'", 'max_length': '36'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'}),
