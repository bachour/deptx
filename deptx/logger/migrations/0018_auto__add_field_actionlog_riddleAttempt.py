...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActionLog.riddleAttempt'
        db.add_column(u'logger_actionlog', 'riddleAttempt',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cron.RiddleAttempt'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActionLog.riddleAttempt'
        db.delete_column(u'logger_actionlog', 'riddleAttempt_id')
    ...
    models = {
        ...
        u'logger.actionlog': {
            ...
            'riddleAttempt': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cron.RiddleAttempt']", 'null': 'True', 'blank': 'True'}),
        ...
        u'mop.mail': {
            ...
            'requisitionBlank': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mop.RequisitionBlank']", 'null': 'True', 'blank': 'True'}),
            'requisitionInstance': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mop.RequisitionInstance']", 'null': 'True', 'blank': 'True'}),
            'sentAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 21, 0, 0)'}),
            'serial': ('django.db.models.fields.CharField', [], {'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'67e11740-b119-11e3-8129'", 'max_length': '36'}),
