...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActionLog.operation'
        db.add_column(u'logger_actionlog', 'operation',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.Operation'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActionLog.operation'
        db.delete_column(u'logger_actionlog', 'operation_id')
    ...
    models = {
        ...
        u'logger.actionlog': {
            ...
            'operation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assets.Operation']", 'null': 'True', 'blank': 'True'}),
        ...
        u'mop.mail': {
            ...
            'requisitionBlank': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mop.RequisitionBlank']", 'null': 'True', 'blank': 'True'}),
            'requisitionInstance': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mop.RequisitionInstance']", 'null': 'True', 'blank': 'True'}),
            'sentAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 28, 0, 0)'}),
            'serial': ('django.db.models.fields.CharField', [], {'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'30eb0263-b68c-11e3-95d6'", 'max_length': '36'}),
