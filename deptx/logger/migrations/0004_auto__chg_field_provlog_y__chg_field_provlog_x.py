...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProvLog.y'
        db.alter_column(u'logger_provlog', 'y', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'ProvLog.x'
        db.alter_column(u'logger_provlog', 'x', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'ProvLog.y'
        db.alter_column(u'logger_provlog', 'y', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ProvLog.x'
        db.alter_column(u'logger_provlog', 'x', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'64287607-56c8-11e3-b24f'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        u'players.mop': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'6427d838-56c8-11e3-a09b'", 'max_length': '36'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'}),
