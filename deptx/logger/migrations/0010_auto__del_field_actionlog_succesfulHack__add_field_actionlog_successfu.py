...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ActionLog.successfulHack'
        db.add_column(u'logger_actionlog', 'successfulHack',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ActionLog.successfulHack'
        db.delete_column(u'logger_actionlog', 'successfulHack')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'8e9eef02-5aa4-11e3-bfcd'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
