...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActionLog.mopFile'
        db.add_column(u'logger_actionlog', 'mopFile',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mop.MopFile'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActionLog.mopFile'
        db.delete_column(u'logger_actionlog', 'mopFile_id')
    ...
    models = {
        ...
        u'mop.mail': {
            ...
            'requisitionInstance': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mop.RequisitionInstance']", 'null': 'True', 'blank': 'True'}),
            'sentAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 23, 0, 0)'}),
            'serial': ('django.db.models.fields.CharField', [], {'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'f21abaa3-6c04-11e3-8c4a'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
