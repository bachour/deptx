...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActionLog.storyFile'
        db.add_column(u'logger_actionlog', 'storyFile',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.StoryFile'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActionLog.storyFile'
        db.delete_column(u'logger_actionlog', 'storyFile_id')
    ...
    models = {
        ...
        u'mop.mail': {
            ...
            'requisitionInstance': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mop.RequisitionInstance']", 'null': 'True', 'blank': 'True'}),
            'sentAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 16, 0, 0)'}),
            'serial': ('django.db.models.fields.CharField', [], {'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'00ebffdc-7ec9-11e3-abb2'", 'max_length': '36'}),
