...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mop.hasCheckedInbox'
        db.add_column(u'players_mop', 'hasCheckedInbox',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mop.hasCheckedInbox'
        db.delete_column(u'players_mop', 'hasCheckedInbox')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'2f8b8e4f-3828-11e3-abf0'", 'max_length': '36'}),
        ...
        u'players.mop': {
            ...
            'hasCheckedInbox': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'2f8b5370-3828-11e3-9295'", 'max_length': '36'}),
            'totalTrust': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'trust': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'unreadMail': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'}),
