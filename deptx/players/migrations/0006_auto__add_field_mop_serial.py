...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mop.serial'
        db.add_column(u'players_mop', 'serial',
                      self.gf('django.db.models.fields.CharField')(default='8b37d657-e8b4-11e2-9492-14109fe17ee1', max_length=36),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mop.serial'
        db.delete_column(u'players_mop', 'serial')
    ...
    models = {
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'8b3c6aeb-e8b4-11e2-bc4a-14109fe17ee1'", 'max_length': '36'}),
