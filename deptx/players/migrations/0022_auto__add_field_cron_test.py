...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cron.test'
        db.add_column(u'players_cron', 'test',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cron.test'
        db.delete_column(u'players_cron', 'test')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'ec889778-5dbf-11e3-a84c'", 'max_length': '36'}),
