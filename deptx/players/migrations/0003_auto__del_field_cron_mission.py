...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Cron.mission'
        raise RuntimeError("Cannot reverse this migration. 'Cron.mission' and its values cannot be restored.")
    ...
    models = {
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'9415f9ae-f939-11e2-8aa8-14109fe17ee1'", 'max_length': '36'}),
