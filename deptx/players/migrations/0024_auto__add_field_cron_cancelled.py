...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cron.cancelled'
        db.add_column(u'players_cron', 'cancelled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cron.cancelled'
        db.delete_column(u'players_cron', 'cancelled')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'f361ed23-787c-11e3-823e'", 'max_length': '36'}),
