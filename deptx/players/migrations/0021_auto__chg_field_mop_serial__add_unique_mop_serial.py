...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Mop.serial'
        db.alter_column(u'players_mop', 'serial', self.gf('django.db.models.fields.CharField')(max_length=32, unique=True, null=True))
        # Adding unique constraint on 'Mop', fields ['serial']
        db.create_unique(u'players_mop', ['serial'])


    def backwards(self, orm):
        # Removing unique constraint on 'Mop', fields ['serial']
        db.delete_unique(u'players_mop', ['serial'])


        # Changing field 'Mop.serial'
        db.alter_column(u'players_mop', 'serial', self.gf('django.db.models.fields.CharField')(max_length=36))
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'d2f58942-5935-11e3-bedd'", 'max_length': '36'}),
