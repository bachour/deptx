...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Player.town'
        raise RuntimeError("Cannot reverse this migration. 'Player.town' and its values cannot be restored.")
        ...
        # User chose to not deal with backwards NULL issues for 'Player.gender'
        raise RuntimeError("Cannot reverse this migration. 'Player.gender' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Player.age'
        raise RuntimeError("Cannot reverse this migration. 'Player.age' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Player.country'
        raise RuntimeError("Cannot reverse this migration. 'Player.country' and its values cannot be restored.")
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'d3254a02-51ff-11e3-9e1a'", 'max_length': '36'}),
        ...
        u'players.mop': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'d3250559-51ff-11e3-bf95'", 'max_length': '36'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'}),
        ...
        u'players.player': {
            ...
            'town': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'})
        }
    }
