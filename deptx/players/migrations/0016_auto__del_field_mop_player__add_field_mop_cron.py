...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Mop.player'
        db.delete_column(u'players_mop', 'player_id')

        # Adding field 'Mop.cron'
        db.add_column(u'players_mop', 'cron',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Mop.player'
        raise RuntimeError("Cannot reverse this migration. 'Mop.player' and its values cannot be restored.")
        # Deleting field 'Mop.cron'
        db.delete_column(u'players_mop', 'cron_id')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'35423747-51f0-11e3-9aea'", 'max_length': '36'}),
        ...
        u'players.mop': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'35426d4c-51f0-11e3-9191'", 'max_length': '36'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'}),
