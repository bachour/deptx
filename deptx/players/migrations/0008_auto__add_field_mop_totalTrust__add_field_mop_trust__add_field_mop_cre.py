...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mop.totalTrust'
        db.add_column(u'players_mop', 'totalTrust',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Mop.trust'
        db.add_column(u'players_mop', 'trust',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Mop.credit'
        db.add_column(u'players_mop', 'credit',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Mop.clearance'
        db.add_column(u'players_mop', 'clearance',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mop.totalTrust'
        db.delete_column(u'players_mop', 'totalTrust')

        # Deleting field 'Mop.trust'
        db.delete_column(u'players_mop', 'trust')

        # Deleting field 'Mop.credit'
        db.delete_column(u'players_mop', 'credit')

        # Deleting field 'Mop.clearance'
        db.delete_column(u'players_mop', 'clearance')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'275d3ae3-3135-11e3-b424'", 'max_length': '36'}),
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'275db6eb-3135-11e3-a597'", 'max_length': '36'}),
