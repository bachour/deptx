...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mop.unreadMail'
        db.add_column(u'players_mop', 'unreadMail',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mop.unreadMail'
        db.delete_column(u'players_mop', 'unreadMail')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'3fbd16ba-3827-11e3-9421'", 'max_length': '36'}),
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'3fbd7e40-3827-11e3-82ad'", 'max_length': '36'}),
