...
from prov.persistence.models import PDBundle, PDNamespace, PDRecord, RecordAttribute, LiteralAttribute
...
admin.site.register(PDRecord)
admin.site.register(RecordAttribute)
admin.site.register(LiteralAttribute)