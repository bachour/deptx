...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ChatMessage.message'
        db.alter_column(u'cron_chatmessage', 'message', self.gf('django.db.models.fields.CharField')(default='haha', max_length=256))

    def backwards(self, orm):

        # Changing field 'ChatMessage.message'
        db.alter_column(u'cron_chatmessage', 'message', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'5cb55705-88ff-11e3-a3aa'", 'max_length': '36'}),
