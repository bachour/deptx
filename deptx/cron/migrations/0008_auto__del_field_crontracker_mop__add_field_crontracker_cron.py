...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CronTracker.mop'
        db.delete_column(u'cron_crontracker', 'mop_id')

        # Adding field 'CronTracker.cron'
        db.add_column(u'cron_crontracker', 'cron',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, related_name='cronTracker', unique=True, to=orm['players.Cron']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CronTracker.mop'
        raise RuntimeError("Cannot reverse this migration. 'CronTracker.mop' and its values cannot be restored.")
        # Deleting field 'CronTracker.cron'
        db.delete_column(u'cron_crontracker', 'cron_id')
    ...
    models = {
        ...
        u'cron.crontracker': {
            ...
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'cron': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'cronTracker'", 'unique': 'True', 'to': u"orm['players.Cron']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'5cd5fbe3-52bf-11e3-81d3'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
