...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CaseQuestionInstance'
        db.create_table(u'cron_casequestioninstance', (
            ...
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.CaseQuestion'])),
            ('correct', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('failedAttempts', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('answer1', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('answer2', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
        ...
        db.send_create_signal(u'cron', ['CaseQuestionInstance'])


    def backwards(self, orm):
        # Deleting model 'CaseQuestionInstance'
        db.delete_table(u'cron_casequestioninstance')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'6685a0e1-60eb-11e3-82c6'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
