...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CronDocumentInstance.failedAttempts'
        db.add_column(u'cron_crondocumentinstance', 'failedAttempts',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CronDocumentInstance.failedAttempts'
        db.delete_column(u'cron_crondocumentinstance', 'failedAttempts')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'c50f7647-52bc-11e3-b70b'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
