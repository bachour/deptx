...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HelpMail.isRead'
        db.add_column(u'cron_helpmail', 'isRead',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HelpMail.isRead'
        db.delete_column(u'cron_helpmail', 'isRead')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'67852b1c-61a0-11e3-bc81'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
