...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HelpMail.type'
        db.add_column(u'cron_helpmail', 'type',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HelpMail.type'
        db.delete_column(u'cron_helpmail', 'type')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'3c4edfa1-592a-11e3-8f1e'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
