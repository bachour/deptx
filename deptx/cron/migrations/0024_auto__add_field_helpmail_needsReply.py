...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HelpMail.needsReply'
        db.add_column(u'cron_helpmail', 'needsReply',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HelpMail.needsReply'
        db.delete_column(u'cron_helpmail', 'needsReply')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'f4113fdc-b2d2-11e3-911c'", 'max_length': '36'}),
