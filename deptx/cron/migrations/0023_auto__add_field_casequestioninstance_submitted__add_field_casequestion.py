...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CaseQuestionInstance.submitted'
        db.add_column(u'cron_casequestioninstance', 'submitted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CaseQuestionInstance.isBad'
        db.add_column(u'cron_casequestioninstance', 'isBad',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CaseQuestionInstance.submitted'
        db.delete_column(u'cron_casequestioninstance', 'submitted')

        # Deleting field 'CaseQuestionInstance.isBad'
        db.delete_column(u'cron_casequestioninstance', 'isBad')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'1f79aeee-a9ea-11e3-b442'", 'max_length': '36'}),
