...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CaseQuestionInstance.case'
        db.delete_column(u'cron_casequestioninstance', 'case_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CaseQuestionInstance.case'
        raise RuntimeError("Cannot reverse this migration. 'CaseQuestionInstance.case' and its values cannot be restored.")
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'c50e87d1-60eb-11e3-bd82'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
