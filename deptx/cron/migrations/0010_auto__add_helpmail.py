...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HelpMail'
        db.create_table(u'cron_helpmail', (
            ...
            ('subject', self.gf('django.db.models.fields.IntegerField')()),
            ('body', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'cron', ['HelpMail'])


    def backwards(self, orm):
        # Deleting model 'HelpMail'
        db.delete_table(u'cron_helpmail')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'8faa2c1e-5924-11e3-b4e5'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
