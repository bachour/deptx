...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'RiddleTracker'
        db.delete_table(u'cron_riddletracker')


    def backwards(self, orm):
        # Adding model 'RiddleTracker'
        db.create_table(u'cron_riddletracker', (
            ('riddle', self.gf('django.db.models.fields.related.OneToOneField')(related_name='riddleTracker', unique=True, to=orm['assets.Riddle'])),
        ...
        db.send_create_signal(u'cron', ['RiddleTracker'])
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'8cda4c68-b6af-11e3-84b5'", 'max_length': '36'}),
