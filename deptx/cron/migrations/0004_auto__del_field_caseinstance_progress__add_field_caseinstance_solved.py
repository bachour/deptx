...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CaseInstance.progress'
        db.delete_column(u'cron_caseinstance', 'progress')
    ...
    def backwards(self, orm):
        # Adding field 'CaseInstance.progress'
        db.add_column(u'cron_caseinstance', 'progress',
    ...
    models = {
        u'assets.case': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'c0a68c00-f9fe-11e2-b88b-14109fe17ee1'", 'max_length': '36'})
        },
        u'assets.mission': {
