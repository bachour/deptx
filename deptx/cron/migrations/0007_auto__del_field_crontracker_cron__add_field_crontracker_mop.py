...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CronTracker.mop'
        db.add_column(u'cron_crontracker', 'mop',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'CronTracker.cron'
        raise RuntimeError("Cannot reverse this migration. 'CronTracker.cron' and its values cannot be restored.")
    ...
    models = {
        ...
        u'cron.crontracker': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'mop': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'cronTracker'", 'unique': 'True', 'to': u"orm['players.Cron']"}),
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'4acfd397-52bf-11e3-a2c7'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
