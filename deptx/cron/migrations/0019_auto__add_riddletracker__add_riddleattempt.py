...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RiddleAttempt'
        db.create_table(u'cron_riddleattempt', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('createdAt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modifiedAt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('riddle', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.Riddle'])),
            ('cron', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['players.Cron'])),
            ('attempt', self.gf('django.db.models.fields.CharField')(max_length=36)),
            ('correct', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'cron', ['RiddleAttempt'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'RiddleAttempt'
        db.delete_table(u'cron_riddleattempt')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'0ade21d7-a2fe-11e3-8475'", 'max_length': '36'}),
