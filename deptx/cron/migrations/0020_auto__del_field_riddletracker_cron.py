...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RiddleTracker.cron'
        db.delete_column(u'cron_riddletracker', 'cron_id')


    def backwards(self, orm):
        # Adding field 'RiddleTracker.cron'
        db.add_column(u'cron_riddletracker', 'cron',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['players.Cron'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'1d783a61-a39f-11e3-b456'", 'max_length': '36'}),
