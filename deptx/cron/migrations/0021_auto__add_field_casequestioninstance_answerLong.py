...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CaseQuestionInstance.answerLong'
        db.add_column(u'cron_casequestioninstance', 'answerLong',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CaseQuestionInstance.answerLong'
        db.delete_column(u'cron_casequestioninstance', 'answerLong')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'be612aa6-a933-11e3-93ce'", 'max_length': '36'}),
