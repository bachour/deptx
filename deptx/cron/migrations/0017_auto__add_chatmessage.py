...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cron_chatmessage', (
        ...
        db.send_create_signal(u'cron', ['ChatMessage'])


    def backwards(self, orm):
        # Deleting model 'ChatMessage'
        db.delete_table(u'cron_chatmessage')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'f1240ed4-88f3-11e3-b10f'", 'max_length': '36'}),
