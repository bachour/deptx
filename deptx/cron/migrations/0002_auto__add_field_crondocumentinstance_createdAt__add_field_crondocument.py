...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CronDocumentInstance.createdAt'
        db.add_column(u'cron_crondocumentinstance', 'createdAt',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'CronDocumentInstance.modifiedAt'
        db.add_column(u'cron_crondocumentinstance', 'modifiedAt',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'CaseInstance.createdAt'
        db.add_column(u'cron_caseinstance', 'createdAt',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'CaseInstance.modifiedAt'
        db.add_column(u'cron_caseinstance', 'modifiedAt',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'MissionInstance.createdAt'
        db.add_column(u'cron_missioninstance', 'createdAt',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'MissionInstance.modifiedAt'
        db.add_column(u'cron_missioninstance', 'modifiedAt',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CronDocumentInstance.createdAt'
        db.delete_column(u'cron_crondocumentinstance', 'createdAt')

        # Deleting field 'CronDocumentInstance.modifiedAt'
        db.delete_column(u'cron_crondocumentinstance', 'modifiedAt')

        # Deleting field 'CaseInstance.createdAt'
        db.delete_column(u'cron_caseinstance', 'createdAt')

        # Deleting field 'CaseInstance.modifiedAt'
        db.delete_column(u'cron_caseinstance', 'modifiedAt')

        # Deleting field 'MissionInstance.createdAt'
        db.delete_column(u'cron_missioninstance', 'createdAt')

        # Deleting field 'MissionInstance.modifiedAt'
        db.delete_column(u'cron_missioninstance', 'modifiedAt')
    ...
    models = {
        u'assets.case': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'63a95642-3121-11e3-8917'", 'max_length': '36'})
        },
        u'assets.document': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'63a872fd-3121-11e3-a015'", 'max_length': '36'}),
        ...
        u'assets.mission': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'6395db6b-3121-11e3-9272'", 'max_length': '50'})
        },
        u'assets.task': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'63a9262b-3121-11e3-a149'", 'max_length': '36'}),
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'63a914f0-3121-11e3-862e'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        u'provmanager.provenance': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'63a9b470-3121-11e3-9ca4'", 'max_length': '36'}),
