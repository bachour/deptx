...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CaseInstance.solved'
        db.delete_column(u'cron_caseinstance', 'solved')


    def backwards(self, orm):
        # Adding field 'CaseInstance.solved'
        db.add_column(u'cron_caseinstance', 'solved',
    ...
    models = {
        u'assets.case': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'954715fa-302e-11e3-ae14'", 'max_length': '36'})
        },
        u'assets.document': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'954727f3-302e-11e3-bb79'", 'max_length': '36'}),
        ...
        u'assets.mission': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'9535da9e-302e-11e3-afb7'", 'max_length': '50'})
        },
        u'assets.task': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'9546922e-302e-11e3-9ea2'", 'max_length': '36'}),
            'trust': ('django.db.models.fields.IntegerField', [], {'default': '25'}),
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'9546b940-302e-11e3-bd1f'", 'max_length': '36'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'provmanager.provenance': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'95479823-302e-11e3-a8af'", 'max_length': '36'}),
