...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OperationTracker'
        db.create_table(u'cron_operationtracker', (
            ...
            ('operation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.Operation'])),
            ('hasInfiltrated', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'cron', ['OperationTracker'])


    def backwards(self, orm):
        # Deleting model 'OperationTracker'
        db.delete_table(u'cron_operationtracker')
    ...
    models = {
        ...
        u'cron.casequestioninstance': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'isBad': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        u'cron.operationtracker': {
            'Meta': {'object_name': 'OperationTracker'},
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'cron': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['players.Cron']"}),
            'hasInfiltrated': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'operation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assets.Operation']"})
        },
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'854fa251-b82a-11e3-81d0'", 'max_length': '36'}),
