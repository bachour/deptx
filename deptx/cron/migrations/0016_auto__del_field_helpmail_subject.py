...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HelpMail.subject'
        db.delete_column(u'cron_helpmail', 'subject')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'HelpMail.subject'
        raise RuntimeError("Cannot reverse this migration. 'HelpMail.subject' and its values cannot be restored.")
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'4bd3b00c-6b4a-11e3-a68b'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
