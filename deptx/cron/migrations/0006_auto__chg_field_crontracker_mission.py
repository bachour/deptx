...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CronTracker.mission'
        db.alter_column(u'cron_crontracker', 'mission_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.Mission'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CronTracker.mission'
        raise RuntimeError("Cannot reverse this migration. 'CronTracker.mission' and its values cannot be restored.")
    ...
    models = {
        u'assets.case': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'b90f65cf-ff72-11e2-b387-14109fe17ee1'", 'max_length': '36'})
        },
        u'assets.document': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'b90ed88f-ff72-11e2-b1c9-14109fe17ee1'", 'max_length': '36'}),
        ...
        u'assets.task': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'b90ef7cf-ff72-11e2-8b19-14109fe17ee1'", 'max_length': '36'}),
        ...
        u'assets.unit': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'b90f7c63-ff72-11e2-80d5-14109fe17ee1'", 'max_length': '36'})
        },
        u'auth.group': {
        ...
        u'cron.crontracker': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mission': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assets.Mission']", 'null': 'True'}),
