...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HelpMail.isReply'
        db.add_column(u'cron_helpmail', 'isReply',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HelpMail.isReply'
        db.delete_column(u'cron_helpmail', 'isReply')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'b2362ea1-5c05-11e3-ae8f'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
