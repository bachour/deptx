...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'cron_crontracker', (
            ('cron', self.gf('django.db.models.fields.related.OneToOneField')(related_name='cronTracker', unique=True, to=orm['players.Cron'])),
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'10737a42-52c2-11e3-8a82'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
