...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Riddle.scriptContent'
        db.alter_column(u'assets_riddle', 'scriptContent', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'Riddle.scriptContent'
        db.alter_column(u'assets_riddle', 'scriptContent', self.gf('django.db.models.fields.TextField')())
