...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoryFile.mediatype'
        db.add_column(u'assets_storyfile', 'mediatype',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoryFile.mediatype'
        db.delete_column(u'assets_storyfile', 'mediatype')
