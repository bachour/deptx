...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AbstractDocument.guide'
        db.add_column(u'assets_abstractdocument', 'guide',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AbstractDocument.guide'
        db.delete_column(u'assets_abstractdocument', 'guide')
