...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'assets_requisition', 'serial', self.gf('django.db.models.fields.CharField')(max_length=32, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Requisition.serial'
        db.alter_column(u'assets_requisition', 'serial', self.gf('django.db.models.fields.CharField')(unique=True, max_length=16, null=True))
