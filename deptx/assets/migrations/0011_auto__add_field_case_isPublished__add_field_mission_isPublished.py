...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Case.isPublished'
        db.add_column(u'assets_case', 'isPublished',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Mission.isPublished'
        db.add_column(u'assets_mission', 'isPublished',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Case.isPublished'
        db.delete_column(u'assets_case', 'isPublished')

        # Deleting field 'Mission.isPublished'
        db.delete_column(u'assets_mission', 'isPublished')
    ...
    models = {
        u'assets.case': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'690facc0-25c7-11e3-8642-14109fe17ee1'", 'max_length': '36'})
        },
        u'assets.document': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'691017fd-25c7-11e3-9e5c-14109fe17ee1'", 'max_length': '36'}),
        ...
        u'assets.requisition': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'69100370-25c7-11e3-99de-14109fe17ee1'", 'max_length': '36'}),
        ...
        u'assets.task': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'691035ca-25c7-11e3-912f-14109fe17ee1'", 'max_length': '36'}),
            'trust': ('django.db.models.fields.IntegerField', [], {'default': '25'})
        },
        u'assets.unit': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'690fc07d-25c7-11e3-80c4-14109fe17ee1'", 'max_length': '36'})
        },
        u'provmanager.provenance': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'690fe8d4-25c7-11e3-8492-14109fe17ee1'", 'max_length': '36'}),
