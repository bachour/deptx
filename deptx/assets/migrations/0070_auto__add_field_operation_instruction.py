...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Operation.instruction'
        db.add_column(u'assets_operation', 'instruction',
                      self.gf('django.db.models.fields.TextField')(default='nothing'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Operation.instruction'
        db.delete_column(u'assets_operation', 'instruction')
