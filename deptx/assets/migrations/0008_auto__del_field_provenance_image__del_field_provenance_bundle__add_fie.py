...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Provenance.image'
        db.delete_column(u'assets_provenance', 'image')

        # Deleting field 'Provenance.bundle'
        db.delete_column(u'assets_provenance', 'bundle_id')

        # Adding field 'Provenance.pdBundle'
        db.add_column(u'assets_provenance', 'pdBundle',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['persistence.PDBundle'], unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Provenance.image'
        db.add_column(u'assets_provenance', 'image',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=256),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Provenance.bundle'
        raise RuntimeError("Cannot reverse this migration. 'Provenance.bundle' and its values cannot be restored.")
        # Deleting field 'Provenance.pdBundle'
        db.delete_column(u'assets_provenance', 'pdBundle_id')
    ...
    models = {
        u'assets.document': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'0b99a0b5-efb9-11e2-8cdd-14109fe17ee1'", 'max_length': '36'}),
        ...
        u'assets.requisition': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'0b99cd8c-efb9-11e2-aa51-14109fe17ee1'", 'max_length': '36'}),
        ...
        u'assets.task': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'0b99808f-efb9-11e2-ac25-14109fe17ee1'", 'max_length': '36'}),
            'trust': ('django.db.models.fields.IntegerField', [], {'default': '25'}),
            'unit': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assets.Unit']"})
        },
        u'assets.unit': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'0b99f545-efb9-11e2-801f-14109fe17ee1'", 'max_length': '36'})
        },
