...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Riddle.server'
        db.add_column(u'assets_riddle', 'server',
                      self.gf('django.db.models.fields.CharField')(default='n', max_length=16),
                      keep_default=False)

        # Adding field 'Riddle.script'
        db.add_column(u'assets_riddle', 'script',
                      self.gf('django.db.models.fields.CharField')(default='n', max_length=16),
                      keep_default=False)

        # Adding field 'Riddle.scriptContent'
        db.add_column(u'assets_riddle', 'scriptContent',
                      self.gf('django.db.models.fields.TextField')(default='n'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Riddle.server'
        db.delete_column(u'assets_riddle', 'server')

        # Deleting field 'Riddle.script'
        db.delete_column(u'assets_riddle', 'script')

        # Deleting field 'Riddle.scriptContent'
        db.delete_column(u'assets_riddle', 'scriptContent')
    ...
    models = {
        ...
        u'assets.riddle': {
            ...
            'scriptContent': ('django.db.models.fields.TextField', [], {}),
