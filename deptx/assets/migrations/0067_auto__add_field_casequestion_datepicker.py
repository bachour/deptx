...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CaseQuestion.datepicker'
        db.add_column(u'assets_casequestion', 'datepicker',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CaseQuestion.datepicker'
        db.delete_column(u'assets_casequestion', 'datepicker')
