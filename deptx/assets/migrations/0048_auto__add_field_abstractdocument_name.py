...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AbstractDocument.name'
        db.add_column(u'assets_abstractdocument', 'name',
                      self.gf('django.db.models.fields.CharField')(default='no name assigned', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AbstractDocument.name'
        db.delete_column(u'assets_abstractdocument', 'name')
