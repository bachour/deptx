...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'assets_performanceperiod')


        # Changing field 'AbstractDocument.name'
        db.alter_column(u'assets_abstractdocument', 'name', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):
        # Adding model 'PerformancePeriod'
        db.create_table(u'assets_performanceperiod', (
        ...
        db.send_create_signal(u'assets', ['PerformancePeriod'])


        # Changing field 'AbstractDocument.name'
        db.alter_column(u'assets_abstractdocument', 'name', self.gf('django.db.models.fields.CharField')(max_length=64))
