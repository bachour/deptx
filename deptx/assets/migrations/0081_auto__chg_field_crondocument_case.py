...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CronDocument.case'
        db.alter_column(u'assets_crondocument', 'case_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['assets.Case']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CronDocument.case'
        raise RuntimeError("Cannot reverse this migration. 'CronDocument.case' and its values cannot be restored.")
