...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'assets_crondocument', 'case_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['assets.Case']))

        # Changing field 'AbstractDocument.provenance'
        db.alter_column(u'assets_abstractdocument', 'provenance_id', self.gf('django.db.models.fields.related.OneToOneField')(default=1, unique=True, to=orm['provmanager.Provenance']))

    def backwards(self, orm):

        # Changing field 'CronDocument.case'
        db.alter_column(u'assets_crondocument', 'case_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.Case'], null=True))

        # Changing field 'AbstractDocument.provenance'
        db.alter_column(u'assets_abstractdocument', 'provenance_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['provmanager.Provenance']))
