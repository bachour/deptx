...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Requisition.isTutorial'
        db.delete_column(u'assets_requisition', 'isTutorial')

        # Deleting field 'Requisition.isInitial'
        db.delete_column(u'assets_requisition', 'isInitial')

        # Adding field 'Requisition.type'
        db.add_column(u'assets_requisition', 'type',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Requisition.isTutorial'
        db.add_column(u'assets_requisition', 'isTutorial',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Requisition.isInitial'
        db.add_column(u'assets_requisition', 'isInitial',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Requisition.type'
        db.delete_column(u'assets_requisition', 'type')
