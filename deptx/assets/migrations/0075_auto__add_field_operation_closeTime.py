...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Operation.closeTime'
        db.add_column(u'assets_operation', 'closeTime',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 30, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Operation.closeTime'
        db.delete_column(u'assets_operation', 'closeTime')
