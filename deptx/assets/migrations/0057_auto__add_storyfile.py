...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StoryFile'
        db.create_table(u'assets_storyfile', (
            ...
            ('serial', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=36)),
            ('data', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'assets', ['StoryFile'])


    def backwards(self, orm):
        # Deleting model 'StoryFile'
        db.delete_table(u'assets_storyfile')
