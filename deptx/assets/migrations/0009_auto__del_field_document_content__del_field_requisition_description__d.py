...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'assets_document', 'content')

        # Deleting field 'Requisition.description'
        db.delete_column(u'assets_requisition', 'description')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Document.content'
        raise RuntimeError("Cannot reverse this migration. 'Document.content' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Requisition.description'
        raise RuntimeError("Cannot reverse this migration. 'Requisition.description' and its values cannot be restored.")
    ...
    models = {
        u'assets.case': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'3c6273a8-2214-11e3-a7d4-14109fe17ee1'", 'max_length': '36'})
        },
        u'assets.document': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'3c629b63-2214-11e3-afc0-14109fe17ee1'", 'max_length': '36'}),
        ...
        u'assets.requisition': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'3c62d399-2214-11e3-95fa-14109fe17ee1'", 'max_length': '36'}),
        ...
        u'assets.task': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'3c62beee-2214-11e3-b2ad-14109fe17ee1'", 'max_length': '36'}),
            'trust': ('django.db.models.fields.IntegerField', [], {'default': '25'}),
            'unit': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assets.Unit']"})
        },
        u'assets.unit': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'3c628730-2214-11e3-9e9a-14109fe17ee1'", 'max_length': '36'})
        },
        u'provmanager.provenance': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'3c624a6b-2214-11e3-ac73-14109fe17ee1'", 'max_length': '36'}),
