...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mission.serial'
        db.add_column(u'assets_mission', 'serial',
                      self.gf('django.db.models.fields.SlugField')(default='2f2e9e94-2c7a-11e3-96ab', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mission.serial'
        db.delete_column(u'assets_mission', 'serial')
    ...
    models = {
        u'assets.case': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'2f3bdae6-2c7a-11e3-aa3e'", 'max_length': '36'})
        },
        u'assets.document': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'2f3c2085-2c7a-11e3-8c86'", 'max_length': '36'}),
        ...
        u'assets.mission': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'2f2e9e94-2c7a-11e3-96ab'", 'max_length': '50'})
        },
        u'assets.requisition': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'2f3bedf8-2c7a-11e3-9ed8'", 'max_length': '36'}),
            'trust': ('django.db.models.fields.IntegerField', [], {'default': '25'}),
        ...
        u'assets.task': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'2f3c397a-2c7a-11e3-8adb'", 'max_length': '36'}),
            'trust': ('django.db.models.fields.IntegerField', [], {'default': '25'}),
            'unit': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assets.Unit']"})
        },
        u'assets.unit': {
        ...
        u'provmanager.provenance': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'2f3c05f3-2c7a-11e3-9282'", 'max_length': '36'}),
