...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CaseQuestion.explanation'
        db.add_column(u'assets_casequestion', 'explanation',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CaseQuestion.explanation'
        db.delete_column(u'assets_casequestion', 'explanation')
