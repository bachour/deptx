...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Unit.isAdministrative'
        db.delete_column(u'assets_unit', 'isAdministrative')

        # Adding field 'Task.description'
        db.add_column(u'assets_task', 'description',
                      self.gf('django.db.models.fields.TextField')(default='description'),
                      keep_default=False)

        # Adding field 'Task.unit'
        db.add_column(u'assets_task', 'unit',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['assets.Unit']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Unit.isAdministrative'
        db.add_column(u'assets_unit', 'isAdministrative',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Task.description'
        db.delete_column(u'assets_task', 'description')

        # Deleting field 'Task.unit'
        db.delete_column(u'assets_task', 'unit_id')
    ...
    models = {
        u'assets.case': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'2e21b0ee-2ae0-11e3-bd32-14109fe17ee1'", 'max_length': '36'})
        },
        u'assets.document': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'2e218fb8-2ae0-11e3-8d3c-14109fe17ee1'", 'max_length': '36'}),
        ...
        u'assets.requisition': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'2e21c3ab-2ae0-11e3-a206-14109fe17ee1'", 'max_length': '36'}),
        ...
        u'assets.task': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'2e21da99-2ae0-11e3-8794-14109fe17ee1'", 'max_length': '36'}),
            'trust': ('django.db.models.fields.IntegerField', [], {'default': '25'}),
            'unit': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assets.Unit']"})
        },
        u'assets.unit': {
        ...
        u'provmanager.provenance': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 1, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'2e215a0a-2ae0-11e3-af06-14109fe17ee1'", 'max_length': '36'}),
