...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Riddle.secondsForAutosolve'
        db.add_column(u'assets_riddle', 'secondsForAutosolve',
                      self.gf('django.db.models.fields.IntegerField')(default=120),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Riddle.secondsForAutosolve'
        db.delete_column(u'assets_riddle', 'secondsForAutosolve')
