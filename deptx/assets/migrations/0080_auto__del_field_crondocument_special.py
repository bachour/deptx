...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CronDocument.special'
        db.delete_column(u'assets_crondocument', 'special')


    def backwards(self, orm):
        # Adding field 'CronDocument.special'
        db.add_column(u'assets_crondocument', 'special',
