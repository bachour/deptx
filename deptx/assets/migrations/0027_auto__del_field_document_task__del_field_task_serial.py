...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'assets_document', 'task',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['assets.Task'], unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Task.serial'
        db.add_column(u'assets_task', 'serial',
                      self.gf('django.db.models.fields.CharField')(default='5d3ba121-3121-11e3-84b5', max_length=36),
                      keep_default=False)
    ...
    models = {
        u'assets.case': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'8a0311d1-31c5-11e3-a865'", 'max_length': '36'})
        },
        u'assets.document': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'8a026814-31c5-11e3-8208'", 'max_length': '36'})
        },
        u'assets.mission': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'89f69387-31c5-11e3-ac8d'", 'max_length': '50'})
        },
        u'assets.requisition': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'8a02decc-31c5-11e3-8624'", 'max_length': '36'}),
        ...
        u'provmanager.provenance': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'8a037530-31c5-11e3-a743'", 'max_length': '36'}),
