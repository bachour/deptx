...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CronDocument.hideSerial'
        db.add_column(u'assets_crondocument', 'hideSerial',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CronDocument.hideSerial'
        db.delete_column(u'assets_crondocument', 'hideSerial')
