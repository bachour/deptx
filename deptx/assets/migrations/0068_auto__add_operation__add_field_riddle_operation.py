...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'assets_operation', (
            ...
            ('serial', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('startTime', self.gf('django.db.models.fields.DateTimeField')()),
            ('stopTime', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'assets', ['Operation'])

        # Adding field 'Riddle.operation'
        db.add_column(u'assets_riddle', 'operation',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['assets.Operation']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Operation'
        db.delete_table(u'assets_operation')

        # Deleting field 'Riddle.operation'
        db.delete_column(u'assets_riddle', 'operation_id')
