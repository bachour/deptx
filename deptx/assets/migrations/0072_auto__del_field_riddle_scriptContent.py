...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Riddle.scriptContent'
        raise RuntimeError("Cannot reverse this migration. 'Riddle.scriptContent' and its values cannot be restored.")
