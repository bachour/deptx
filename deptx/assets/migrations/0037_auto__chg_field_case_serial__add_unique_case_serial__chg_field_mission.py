...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Case.serial'
        db.alter_column(u'assets_case', 'serial', self.gf('django.db.models.fields.SlugField')(max_length=36, unique=True, null=True))
        # Adding unique constraint on 'Case', fields ['serial']
        db.create_unique(u'assets_case', ['serial'])


        # Changing field 'Mission.serial'
        db.alter_column(u'assets_mission', 'serial', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True, null=True))
        # Adding unique constraint on 'Mission', fields ['serial']
        db.create_unique(u'assets_mission', ['serial'])


        # Changing field 'Document.serial'
        db.alter_column(u'assets_document', 'serial', self.gf('django.db.models.fields.CharField')(max_length=36, unique=True, null=True))
        # Adding unique constraint on 'Document', fields ['serial']
        db.create_unique(u'assets_document', ['serial'])

        # Adding unique constraint on 'Unit', fields ['serial']
        db.create_unique(u'assets_unit', ['serial'])


        # Changing field 'Requisition.serial'
        db.alter_column(u'assets_requisition', 'serial', self.gf('django.db.models.fields.CharField')(unique=True, max_length=16))
        # Adding unique constraint on 'Requisition', fields ['serial']
        db.create_unique(u'assets_requisition', ['serial'])


    def backwards(self, orm):
        # Removing unique constraint on 'Requisition', fields ['serial']
        db.delete_unique(u'assets_requisition', ['serial'])

        # Removing unique constraint on 'Unit', fields ['serial']
        db.delete_unique(u'assets_unit', ['serial'])

        # Removing unique constraint on 'Document', fields ['serial']
        db.delete_unique(u'assets_document', ['serial'])

        # Removing unique constraint on 'Mission', fields ['serial']
        db.delete_unique(u'assets_mission', ['serial'])

        # Removing unique constraint on 'Case', fields ['serial']
        db.delete_unique(u'assets_case', ['serial'])


        # Changing field 'Case.serial'
        db.alter_column(u'assets_case', 'serial', self.gf('django.db.models.fields.SlugField')(max_length=36))

        # Changing field 'Mission.serial'
        db.alter_column(u'assets_mission', 'serial', self.gf('django.db.models.fields.SlugField')(max_length=50))

        # Changing field 'Document.serial'
        db.alter_column(u'assets_document', 'serial', self.gf('django.db.models.fields.CharField')(max_length=36))

        # Changing field 'Requisition.serial'
        db.alter_column(u'assets_requisition', 'serial', self.gf('django.db.models.fields.CharField')(max_length=32))
    ...
    models = {
        ...
        u'assets.requisition': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '16'}),
        ...
        u'provmanager.provenance': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'c8de1187-40d5-11e3-9515'", 'max_length': '36'}),
