...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Mission.test'
        db.delete_column(u'assets_mission', 'test')


    def backwards(self, orm):
        # Adding field 'Mission.test'
        db.add_column(u'assets_mission', 'test',
    ...
    models = {
        u'assets.case': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'7618c5b5-2c7a-11e3-a5b0'", 'max_length': '36'})
        },
        u'assets.document': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'761909e1-2c7a-11e3-af1f'", 'max_length': '36'}),
        ...
        u'assets.mission': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'760b2bc2-2c7a-11e3-a0bd'", 'max_length': '50'})
        },
        u'assets.requisition': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'7618d86e-2c7a-11e3-b0fc'", 'max_length': '36'}),
            'trust': ('django.db.models.fields.IntegerField', [], {'default': '25'}),
        ...
        u'assets.task': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'76192497-2c7a-11e3-890e'", 'max_length': '36'}),
            'trust': ('django.db.models.fields.IntegerField', [], {'default': '25'}),
            'unit': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assets.Unit']"})
        },
        u'assets.unit': {
        ...
        u'provmanager.provenance': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'7618efc0-2c7a-11e3-af66'", 'max_length': '36'}),
