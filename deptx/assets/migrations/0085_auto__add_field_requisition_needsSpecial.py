...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Requisition.needsSpecial'
        db.add_column(u'assets_requisition', 'needsSpecial',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Requisition.needsSpecial'
        db.delete_column(u'assets_requisition', 'needsSpecial')
