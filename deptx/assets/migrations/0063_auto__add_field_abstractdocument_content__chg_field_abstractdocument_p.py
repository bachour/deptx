...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AbstractDocument.content'
        db.add_column(u'assets_abstractdocument', 'content',
    ...
    def backwards(self, orm):
        # Deleting field 'AbstractDocument.content'
        db.delete_column(u'assets_abstractdocument', 'content')


        # User chose to not deal with backwards NULL issues for 'AbstractDocument.provenance'
        raise RuntimeError("Cannot reverse this migration. 'AbstractDocument.provenance' and its values cannot be restored.")
