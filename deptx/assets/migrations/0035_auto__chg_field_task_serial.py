...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Task.serial'
        db.alter_column(u'assets_task', 'serial', self.gf('django.db.models.fields.CharField')(max_length=32))

    def backwards(self, orm):

        # Changing field 'Task.serial'
        db.alter_column(u'assets_task', 'serial', self.gf('django.db.models.fields.CharField')(max_length=16))
    ...
    models = {
        u'assets.case': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'45568994-40bf-11e3-bd64'", 'max_length': '36'})
        },
        u'assets.document': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'4556330f-40bf-11e3-9c10'", 'max_length': '36'})
        },
        u'assets.mission': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'454a0de1-40bf-11e3-86e2'", 'max_length': '50'})
        },
        ...
        u'provmanager.provenance': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'455650f3-40bf-11e3-81e7'", 'max_length': '36'}),
