...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AbstractDocument.special'
        db.add_column(u'assets_abstractdocument', 'special',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AbstractDocument.special'
        db.delete_column(u'assets_abstractdocument', 'special')
