...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CronDocument.secondaryCase'
        db.add_column(u'assets_crondocument', 'secondaryCase',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='crondocument2', null=True, to=orm['assets.Case']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CronDocument.secondaryCase'
        db.delete_column(u'assets_crondocument', 'secondaryCase_id')
    ...
    models = {
        ...
        u'assets.casequestion': {
            ...
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'datepicker': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'assets.crondocument': {
            ...
            'autoSolve': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'case': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'crondocument'", 'null': 'True', 'to': u"orm['assets.Case']"}),
            'clearance': ('django.db.models.fields.IntegerField', [], {'default': '100'}),
            'hideSerial': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'secondaryCase': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'crondocument2'", 'null': 'True', 'to': u"orm['assets.Case']"}),
        ...
        u'assets.mission': {
            ...
            'isLastMission': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'isPublished': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
        ...
        u'assets.operation': {
            ...
            'stopTime': ('django.db.models.fields.DateTimeField', [], {})
        },
        u'assets.requisition': {
            ...
            'needsSpecial': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'assets.riddle': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'operation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assets.Operation']"}),
            'rank': ('django.db.models.fields.IntegerField', [], {}),
            'script': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
            'scriptContent': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'secondsForAutosolve': ('django.db.models.fields.IntegerField', [], {'default': '120'}),
            'server': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
        ...
        u'assets.unit': {
            ...
            'mail_revoking_document': ('django.db.models.fields.TextField', [], {'default': "'Document {{data}} was not processed in time. The document has been revoked.'"}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
