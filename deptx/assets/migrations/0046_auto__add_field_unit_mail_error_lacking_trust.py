...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Unit.mail_error_lacking_trust'
        db.add_column(u'assets_unit', 'mail_error_lacking_trust',
                      self.gf('django.db.models.fields.TextField')(default='You do not have the required amount of performance credits to request document {{data}}.'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Unit.mail_error_lacking_trust'
        db.delete_column(u'assets_unit', 'mail_error_lacking_trust')
