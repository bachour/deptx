...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'assets_document', 'level')

        # Adding field 'Document.clearance'
        db.add_column(u'assets_document', 'clearance',
                      self.gf('django.db.models.fields.IntegerField')(default=100),
                      keep_default=False)

        # Deleting field 'Task.level'
        db.delete_column(u'assets_task', 'level')

        # Adding field 'Task.clearance'
        db.add_column(u'assets_task', 'clearance',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'assets_document', 'level',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Document.clearance'
        db.delete_column(u'assets_document', 'clearance')

        # Adding field 'Task.level'
        db.add_column(u'assets_task', 'level',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Task.clearance'
        db.delete_column(u'assets_task', 'clearance')
    ...
    models = {
        u'assets.case': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'e23ed21e-31cb-11e3-a1f9'", 'max_length': '36'})
        },
        u'assets.document': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'e23f5a4a-31cb-11e3-8fe9'", 'max_length': '36'})
        },
        u'assets.mission': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'e2333351-31cb-11e3-8a35'", 'max_length': '50'})
        },
        u'assets.requisition': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'e23f2b30-31cb-11e3-884e'", 'max_length': '36'}),
        ...
        u'provmanager.provenance': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'e23f0efd-31cb-11e3-889b'", 'max_length': '36'}),
