...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'assets_document', 'unit',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['assets.Unit']),
                      keep_default=False)


        # Changing field 'Requisition.serial'
        db.alter_column(u'assets_requisition', 'serial', self.gf('django.db.models.fields.CharField')(max_length=16, unique=True, null=True))
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'assets_task', (
            ...
            ('provenance', self.gf('django.db.models.fields.related.OneToOneField')(related_name='task', unique=True, null=True, to=orm['provmanager.Provenance'], blank=True)),
        ...
        db.delete_column(u'assets_document', 'unit_id')


        # User chose to not deal with backwards NULL issues for 'Requisition.serial'
        raise RuntimeError("Cannot reverse this migration. 'Requisition.serial' and its values cannot be restored.")
    ...
    models = {
        ...
        u'provmanager.provenance': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'2e2239f8-4adf-11e3-a508'", 'max_length': '36'}),
