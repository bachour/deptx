...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Document.case'
        db.add_column(u'assets_document', 'case',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['assets.Case']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Document.case'
        db.delete_column(u'assets_document', 'case_id')
    ...
    models = {
        ...
        u'assets.document': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'e53913e1-f9e6-11e2-afe4-14109fe17ee1'", 'max_length': '36'}),
        ...
        u'assets.requisition': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'e538e6ca-f9e6-11e2-80c0-14109fe17ee1'", 'max_length': '36'}),
        ...
        u'assets.task': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'e53956ab-f9e6-11e2-94e4-14109fe17ee1'", 'max_length': '36'}),
            'trust': ('django.db.models.fields.IntegerField', [], {'default': '25'}),
            'unit': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assets.Unit']"})
        },
        u'assets.unit': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'e5396eee-f9e6-11e2-a98d-14109fe17ee1'", 'max_length': '36'})
        },
