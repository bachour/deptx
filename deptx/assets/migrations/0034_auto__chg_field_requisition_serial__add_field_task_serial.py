...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Task.serial'
        db.add_column(u'assets_task', 'serial',
                      self.gf('django.db.models.fields.CharField')(default='ttt', max_length=16),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Requisition.serial'
        db.alter_column(u'assets_requisition', 'serial', self.gf('django.db.models.fields.CharField')(max_length=16))
        # Deleting field 'Task.serial'
        db.delete_column(u'assets_task', 'serial')
    ...
    models = {
        u'assets.case': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'5399d482-40be-11e3-b098'", 'max_length': '36'})
        },
        u'assets.document': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'53999863-40be-11e3-a1d7'", 'max_length': '36'})
        },
        u'assets.mission': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'49e3a863-40be-11e3-867d'", 'max_length': '50'})
        },
        ...
        u'provmanager.provenance': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'5399b580-40be-11e3-a261'", 'max_length': '36'}),
