...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CronDocument.clearance'
        db.add_column(u'assets_crondocument', 'clearance',
                      self.gf('django.db.models.fields.IntegerField')(default=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CronDocument.clearance'
        db.delete_column(u'assets_crondocument', 'clearance')
