...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CaseQuestion'
        db.create_table(u'assets_casequestion', (
            ...
            ('correct1', self.gf('django.db.models.fields.TextField')()),
            ('wrong1', self.gf('django.db.models.fields.TextField')()),
            ('correct2', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('wrong2', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'assets', ['CaseQuestion'])


    def backwards(self, orm):
        # Deleting model 'CaseQuestion'
        db.delete_table(u'assets_casequestion')
