...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'assets_document', 'type',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'assets_document', 'type')
    ...
    models = {
        ...
        u'provmanager.provenance': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'18b4b407-4ae9-11e3-84f0'", 'max_length': '36'}),
