...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'assets_unit', 'serial', self.gf('django.db.models.fields.CharField')(max_length=4))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Unit.serial'
        db.alter_column(u'assets_unit', 'serial', self.gf('django.db.models.fields.CharField')(max_length=8, unique=True))
        # Adding unique constraint on 'Unit', fields ['serial']
        db.create_unique(u'assets_unit', ['serial'])


        # Changing field 'Requisition.serial'
        db.alter_column(u'assets_requisition', 'serial', self.gf('django.db.models.fields.CharField')(max_length=36))
    ...
    models = {
        u'assets.case': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'2733ccc7-40ba-11e3-939f'", 'max_length': '36'})
        },
        u'assets.document': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'2733aafd-40ba-11e3-b3f5'", 'max_length': '36'})
        },
        u'assets.mission': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'2726eee6-40ba-11e3-a0f5'", 'max_length': '50'})
        },
        ...
        u'provmanager.provenance': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'2732f58a-40ba-11e3-b45c'", 'max_length': '36'}),
