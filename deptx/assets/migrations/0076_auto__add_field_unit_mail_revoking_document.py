...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Unit.mail_revoking_document'
        db.add_column(u'assets_unit', 'mail_revoking_document',
                      self.gf('django.db.models.fields.TextField')(default='Document {{data}} was not processed in time. The document has been revoked.'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Unit.mail_revoking_document'
        db.delete_column(u'assets_unit', 'mail_revoking_document')
