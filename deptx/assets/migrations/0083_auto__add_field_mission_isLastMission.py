...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mission.isLastMission'
        db.add_column(u'assets_mission', 'isLastMission',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mission.isLastMission'
        db.delete_column(u'assets_mission', 'isLastMission')
