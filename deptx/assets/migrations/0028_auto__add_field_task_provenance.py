...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.provenance'
        db.add_column(u'assets_task', 'provenance',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='task', unique=True, null=True, to=orm['provmanager.Provenance']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.provenance'
        db.delete_column(u'assets_task', 'provenance_id')
    ...
    models = {
        u'assets.case': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'cef0a9b0-31c5-11e3-bbea'", 'max_length': '36'})
        },
        u'assets.document': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'ceefed54-31c5-11e3-8378'", 'max_length': '36'})
        },
        u'assets.mission': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'cee41721-31c5-11e3-941c'", 'max_length': '50'})
        },
        u'assets.requisition': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'cef06bcf-31c5-11e3-97ed'", 'max_length': '36'}),
        ...
        u'provmanager.provenance': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'cef0891c-31c5-11e3-a438'", 'max_length': '36'}),
