...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Riddle'
        db.create_table(u'assets_riddle', (
            ...
            ('solution', self.gf('django.db.models.fields.CharField')(max_length=36)),
            ('rank', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'assets', ['Riddle'])


    def backwards(self, orm):
        # Deleting model 'Riddle'
        db.delete_table(u'assets_riddle')
