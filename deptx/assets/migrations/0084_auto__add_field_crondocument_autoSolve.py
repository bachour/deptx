...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CronDocument.autoSolve'
        db.add_column(u'assets_crondocument', 'autoSolve',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CronDocument.autoSolve'
        db.delete_column(u'assets_crondocument', 'autoSolve')
