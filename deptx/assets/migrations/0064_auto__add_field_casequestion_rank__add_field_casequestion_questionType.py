...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CaseQuestion.rank'
        db.add_column(u'assets_casequestion', 'rank',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'CaseQuestion.questionType'
        db.add_column(u'assets_casequestion', 'questionType',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


        # Changing field 'CaseQuestion.wrong1'
        db.alter_column(u'assets_casequestion', 'wrong1', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'CaseQuestion.correct1'
        db.alter_column(u'assets_casequestion', 'correct1', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Deleting field 'CaseQuestion.rank'
        db.delete_column(u'assets_casequestion', 'rank')

        # Deleting field 'CaseQuestion.questionType'
        db.delete_column(u'assets_casequestion', 'questionType')


        # User chose to not deal with backwards NULL issues for 'CaseQuestion.wrong1'
        raise RuntimeError("Cannot reverse this migration. 'CaseQuestion.wrong1' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CaseQuestion.correct1'
        raise RuntimeError("Cannot reverse this migration. 'CaseQuestion.correct1' and its values cannot be restored.")
