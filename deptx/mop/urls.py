...
urlpatterns = patterns('',
    ...
    url(r'intranet/forms/trashing/([-\w]+)/$', views.form_trashing, name='mop_form_trashing'),
    url(r'intranet/forms/([-\w]+)/$', views.form_fill, name='mop_forms_fill'),
    url(r'intranet/forms/([-\w]+)/([-\w]+)', views.form_fill, name='mop_forms_fill'),
    ...
    url(r'intranet/mail/compose/form/([-\w]+)/document/([-\w]+)', views.mail_compose, name='mop_mail_compose'),
    ...
    url(r'intranet/special/$', views.special, name='mop_special'),
    url(r'intranet/special/([-\w]+)/provenance', views.provenance, name='mop_provenance'),
