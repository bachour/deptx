...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Task'
        db.create_table(u'mop_task', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('episode', self.gf('django.db.models.fields.IntegerField')(default=-1)),
            ('trust', self.gf('django.db.models.fields.IntegerField')(default=20)),
            ('value', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal(u'mop', ['Task'])

        # Adding model 'TaskStatus'
        db.create_table(u'mop_taskstatus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mop.Task'])),
            ('mop', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['players.Mop'])),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'mop', ['TaskStatus'])


    def backwards(self, orm):
        # Deleting model 'Task'
        db.delete_table(u'mop_task')

        # Deleting model 'TaskStatus'
        db.delete_table(u'mop_taskstatus')
