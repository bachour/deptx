...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mail.trust'
        db.add_column(u'mop_mail', 'trust',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mail.trust'
        db.delete_column(u'mop_mail', 'trust')
    ...
    models = {
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'f7682d57-4d60-11e3-be08'", 'max_length': '36'}),
