...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Mail.attachement'
        db.delete_column(u'mop_mail', 'attachement_id')

        # Adding field 'Mail.requisition'
        db.add_column(u'mop_mail', 'requisition',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mop.Requisition'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Adding field 'Mail.attachement'
        db.add_column(u'mop_mail', 'attachement',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mop.Document'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'mop.taskstate': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mop': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['players.Mop']"}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'c62007d1-e8b5-11e2-b674-14109fe17ee1'", 'max_length': '36'}),
            'state': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'c61fb82b-e8b5-11e2-b48c-14109fe17ee1'", 'max_length': '36'}),
