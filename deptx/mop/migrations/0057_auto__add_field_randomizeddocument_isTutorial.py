...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RandomizedDocument.isTutorial'
        db.add_column(u'mop_randomizeddocument', 'isTutorial',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RandomizedDocument.isTutorial'
        db.delete_column(u'mop_randomizeddocument', 'isTutorial')
    ...
    models = {
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'163e4202-513e-11e3-9e74'", 'max_length': '36'}),
