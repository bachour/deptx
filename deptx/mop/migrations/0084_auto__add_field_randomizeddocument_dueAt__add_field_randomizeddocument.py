...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RandomizedDocument.dueAt'
        db.add_column(u'mop_randomizeddocument', 'dueAt',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'RandomizedDocument.appearAt'
        db.add_column(u'mop_randomizeddocument', 'appearAt',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RandomizedDocument.dueAt'
        db.delete_column(u'mop_randomizeddocument', 'dueAt')

        # Deleting field 'RandomizedDocument.appearAt'
        db.delete_column(u'mop_randomizeddocument', 'appearAt')
    ...
    models = {
        ...
        u'mop.mail': {
            ...
            'sentAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 22, 0, 0)'}),
            'serial': ('django.db.models.fields.CharField', [], {'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'mop.randomizeddocument': {
            ...
            'appearAt': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'dueAt': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'mop.trustinstance': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'mop': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['players.Mop']"}),
            'newClearance': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'newTrust': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'oldClearance': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'710c358a-e1f1-11e3-857e'", 'max_length': '36'}),
