...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RequisitionInstance.serial'
        db.add_column(u'mop_requisitioninstance', 'serial',
                      self.gf('django.db.models.fields.CharField')(max_length=36, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RequisitionInstance.serial'
        db.delete_column(u'mop_requisitioninstance', 'serial')
    ...
    models = {
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'2358eb99-4bcd-11e3-9913'", 'max_length': '36'}),
