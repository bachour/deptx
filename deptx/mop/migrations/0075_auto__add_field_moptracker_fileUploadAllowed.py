...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MopTracker.fileUploadAllowed'
        db.add_column(u'mop_moptracker', 'fileUploadAllowed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MopTracker.fileUploadAllowed'
        db.delete_column(u'mop_moptracker', 'fileUploadAllowed')
    ...
    models = {
        ...
        u'mop.mail': {
            ...
            'sentAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 9, 0, 0)'}),
            'serial': ('django.db.models.fields.CharField', [], {'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'97c7df2e-793e-11e3-8e90'", 'max_length': '36'}),
