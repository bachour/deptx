...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MopTracker.specialStatus'
        db.delete_column(u'mop_moptracker', 'specialStatus')

        # Adding field 'MopTracker.specialStatusAllowed'
        db.add_column(u'mop_moptracker', 'specialStatusAllowed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'MopTracker.specialStatus'
        db.add_column(u'mop_moptracker', 'specialStatus',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'MopTracker.specialStatusAllowed'
        db.delete_column(u'mop_moptracker', 'specialStatusAllowed')
    ...
    models = {
        ...
        u'mop.mail': {
            ...
            'sentAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 30, 0, 0)'}),
            'serial': ('django.db.models.fields.CharField', [], {'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'7a623607-b833-11e3-aa5c'", 'max_length': '36'}),
