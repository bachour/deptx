...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MopTracker'
        db.create_table(u'mop_moptracker', (
            ...
            ('mop', self.gf('django.db.models.fields.related.OneToOneField')(related_name='mopTracker', unique=True, to=orm['players.Mop'])),
            ...
            ('allowance', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('clearance', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('tutorial', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('tutorialProvErrors', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'mop', ['MopTracker'])


    def backwards(self, orm):
        # Adding model 'TrustTracker'
        db.create_table(u'mop_trusttracker', (
            ('mop', self.gf('django.db.models.fields.related.OneToOneField')(related_name='trustTracker', unique=True, to=orm['players.Mop'])),
            ('trust', self.gf('django.db.models.fields.IntegerField')(default=0)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tutorial', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('tutorialProvErrors', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        # Deleting model 'MopTracker'
        db.delete_table(u'mop_moptracker')
    ...
    models = {
        ...
        u'mop.moptracker': {
            ...
            'allowance': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'clearance': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'fb68e46b-52ba-11e3-bb27'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        u'players.mop': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'fb69cfb8-52ba-11e3-b1b9'", 'max_length': '36'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'}),
