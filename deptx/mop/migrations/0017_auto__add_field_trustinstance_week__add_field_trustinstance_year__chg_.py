...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrustInstance.week'
        db.add_column(u'mop_trustinstance', 'week',
                      self.gf('django.db.models.fields.IntegerField')(default=41),
                      keep_default=False)

        # Adding field 'TrustInstance.year'
        db.add_column(u'mop_trustinstance', 'year',
                      self.gf('django.db.models.fields.IntegerField')(default=2013),
                      keep_default=False)


        # Changing field 'TrustInstance.date'
        db.alter_column(u'mop_trustinstance', 'date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting field 'TrustInstance.week'
        db.delete_column(u'mop_trustinstance', 'week')

        # Deleting field 'TrustInstance.year'
        db.delete_column(u'mop_trustinstance', 'year')


        # Changing field 'TrustInstance.date'
        db.alter_column(u'mop_trustinstance', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    models = {
        u'assets.case': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'0194d74a-3072-11e3-b007'", 'max_length': '36'})
        },
        u'assets.document': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'0194eb68-3072-11e3-b270'", 'max_length': '36'}),
        ...
        u'assets.mission': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'0175ed63-3072-11e3-a128'", 'max_length': '50'})
        },
        u'assets.requisition': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'01959d1c-3072-11e3-9890'", 'max_length': '36'}),
        ...
        u'assets.task': {
            ...
            'level': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'0195887d-3072-11e3-88a6'", 'max_length': '36'}),
            'unit': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assets.Unit']"})
        },
        u'assets.unit': {
        ...
        u'mop.trustinstance': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 9, 0, 0)'}),
            'documentInstance': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mop.DocumentInstance']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mop': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['players.Mop']"}),
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'0195d0f0-3072-11e3-a63c'", 'max_length': '36'}),
        ...
        u'provmanager.provenance': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'01945675-3072-11e3-baa8'", 'max_length': '36'}),
