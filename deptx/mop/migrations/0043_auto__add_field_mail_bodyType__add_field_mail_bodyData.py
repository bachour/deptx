...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mail.bodyType'
        db.add_column(u'mop_mail', 'bodyType',
    ...
    def backwards(self, orm):
        # Deleting field 'Mail.bodyType'
        db.delete_column(u'mop_mail', 'bodyType')
    ...
    models = {
        ...
        u'mop.mail': {
            ...
            'bodyData': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'65bc2068-4d69-11e3-bea1'", 'max_length': '36'}),
