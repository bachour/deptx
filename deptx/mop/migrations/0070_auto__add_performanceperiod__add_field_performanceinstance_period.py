...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PerformancePeriod'
        db.create_table(u'mop_performanceperiod', (
            ...
            ('reviewDate', self.gf('django.db.models.fields.DateField')()),
            ('processed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'mop', ['PerformancePeriod'])

        # Adding field 'PerformanceInstance.period'
        db.add_column(u'mop_performanceinstance', 'period',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['mop.PerformancePeriod']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PerformancePeriod'
        db.delete_table(u'mop_performanceperiod')

        # Deleting field 'PerformanceInstance.period'
        db.delete_column(u'mop_performanceinstance', 'period_id')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'2c4672f3-6290-11e3-b2db'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
