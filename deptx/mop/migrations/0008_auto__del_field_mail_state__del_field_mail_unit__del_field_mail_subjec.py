...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Mail.state'
        db.delete_column(u'mop_mail', 'state')

        # Deleting field 'Mail.unit'
        db.delete_column(u'mop_mail', 'unit')

        # Deleting field 'Mail.subject'
        db.delete_column(u'mop_mail', 'subject')


        # Changing field 'Mail.attachement'
        db.alter_column(u'mop_mail', 'attachement_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mop.Document'], null=True))

    def backwards(self, orm):
        # Adding field 'Mail.state'
        db.add_column(u'mop_mail', 'state',
        ...
        db.add_column(u'mop_mail', 'subject',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Mail.attachement'
        raise RuntimeError("Cannot reverse this migration. 'Mail.attachement' and its values cannot be restored.")
    ...
    models = {
        ...
        u'mop.mail': {
            ...
            'attachement': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mop.Document']", 'null': 'True', 'blank': 'True'}),
