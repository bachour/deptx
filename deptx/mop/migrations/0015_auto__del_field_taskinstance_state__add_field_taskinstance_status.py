...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TaskInstance.state'
        db.delete_column(u'mop_taskinstance', 'state')

        # Adding field 'TaskInstance.status'
        db.add_column(u'mop_taskinstance', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TaskInstance.state'
        db.add_column(u'mop_taskinstance', 'state',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'TaskInstance.status'
        db.delete_column(u'mop_taskinstance', 'status')
    ...
    models = {
        u'assets.case': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'b836b4ab-3059-11e3-9943'", 'max_length': '36'})
        },
        u'assets.document': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'b836c82b-3059-11e3-8f88'", 'max_length': '36'}),
        ...
        u'assets.mission': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'b8174494-3059-11e3-a1d1'", 'max_length': '50'})
        },
        u'assets.requisition': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'b835b30c-3059-11e3-a170'", 'max_length': '36'}),
        ...
        u'assets.task': {
            ...
            'level': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'b8359fc0-3059-11e3-87cb'", 'max_length': '36'}),
            'unit': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assets.Unit']"})
        },
        u'assets.unit': {
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'b8372c70-3059-11e3-b0bf'", 'max_length': '36'}),
        ...
        u'provmanager.provenance': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'b836177a-3059-11e3-b4fe'", 'max_length': '36'}),
