...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DocumentInstance.document'
        db.delete_column(u'mop_documentinstance', 'document_id')

        # Adding field 'DocumentInstance.cronDocument'
        db.add_column(u'mop_documentinstance', 'cronDocument',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.CronDocument'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'RandomizedDocument.document'
        db.alter_column(u'mop_randomizeddocument', 'document_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.MopDocument']))

    def backwards(self, orm):
        # Adding field 'DocumentInstance.document'
        db.add_column(u'mop_documentinstance', 'document',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.Document'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'DocumentInstance.cronDocument'
        db.delete_column(u'mop_documentinstance', 'cronDocument_id')


        # Changing field 'RandomizedDocument.document'
        db.alter_column(u'mop_randomizeddocument', 'document_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.Document']))
    ...
    models = {
        ...
        u'mop.randomizeddocument': {
            ...
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'document': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assets.MopDocument']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'696a7123-4baa-11e3-a905'", 'max_length': '36'}),
