...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'mop.trusttracker': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'mop': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'trustTracker'", 'unique': 'True', 'to': u"orm['players.Mop']"}),
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'d2c31fde-4e27-11e3-9364'", 'max_length': '36'}),
