...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrustTracker.tutorial'
        db.add_column(u'mop_trusttracker', 'tutorial',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrustTracker.tutorial'
        db.delete_column(u'mop_trusttracker', 'tutorial')
    ...
    models = {
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'55d48dd1-506a-11e3-bc45'", 'max_length': '36'}),
