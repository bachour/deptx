...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mail.sentAt'
        db.add_column(u'mop_mail', 'sentAt',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 12, 1, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mail.sentAt'
        db.delete_column(u'mop_mail', 'sentAt')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'447eaa42-5a2a-11e3-9fd6'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
