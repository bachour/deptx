...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RequisitionInstance.type'
        db.delete_column(u'mop_requisitioninstance', 'type')


    def backwards(self, orm):
        # Adding field 'RequisitionInstance.type'
        db.add_column(u'mop_requisitioninstance', 'type',
    ...
    models = {
        u'assets.task': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'3b68dd21-e97a-11e2-b9ae-14109fe17ee1'", 'max_length': '36'}),
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'3b6931fa-e97a-11e2-8749-14109fe17ee1'", 'max_length': '36'}),
