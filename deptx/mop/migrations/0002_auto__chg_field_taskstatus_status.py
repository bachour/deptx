...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TaskStatus.status'
        db.alter_column(u'mop_taskstatus', 'status', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'TaskStatus.status'
        db.alter_column(u'mop_taskstatus', 'status', self.gf('django.db.models.fields.CharField')(max_length=1))
