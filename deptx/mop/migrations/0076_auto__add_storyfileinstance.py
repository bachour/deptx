...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StoryFileInstance'
        db.create_table(u'mop_storyfileinstance', (
            ...
            ('storyFile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.StoryFile'])),
        ))
        db.send_create_signal(u'mop', ['StoryFileInstance'])


    def backwards(self, orm):
        # Deleting model 'StoryFileInstance'
        db.delete_table(u'mop_storyfileinstance')
    ...
    models = {
        ...
        u'mop.mail': {
            ...
            'sentAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 20, 0, 0)'}),
            'serial': ('django.db.models.fields.CharField', [], {'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'904dbca6-9a2e-11e3-85a6'", 'max_length': '36'}),
