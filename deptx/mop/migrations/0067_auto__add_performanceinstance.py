...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PerformanceInstance'
        db.create_table(u'mop_performanceinstance', (
            ...
            ('period', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.PerformancePeriod'])),
        ))
        db.send_create_signal(u'mop', ['PerformanceInstance'])


    def backwards(self, orm):
        # Deleting model 'PerformanceInstance'
        db.delete_table(u'mop_performanceinstance')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'26c3e799-6288-11e3-9ae7'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
