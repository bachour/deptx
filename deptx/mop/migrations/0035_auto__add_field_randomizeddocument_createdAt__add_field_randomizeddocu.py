...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RandomizedDocument.createdAt'
        db.add_column(u'mop_randomizeddocument', 'createdAt',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'RandomizedDocument.modifiedAt'
        db.add_column(u'mop_randomizeddocument', 'modifiedAt',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RandomizedDocument.createdAt'
        db.delete_column(u'mop_randomizeddocument', 'createdAt')

        # Deleting field 'RandomizedDocument.modifiedAt'
        db.delete_column(u'mop_randomizeddocument', 'modifiedAt')
    ...
    models = {
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'a149e3f5-4b02-11e3-98ec'", 'max_length': '36'}),
