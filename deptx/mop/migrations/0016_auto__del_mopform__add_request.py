...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'mop', ['Request'])
    ...
    models = {
        ...
        u'mop.taskstate': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mop': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['players.Mop']"}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'80ae7cb8-e8b0-11e2-bd90-14109fe17ee1'", 'max_length': '36'}),
            'state': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
