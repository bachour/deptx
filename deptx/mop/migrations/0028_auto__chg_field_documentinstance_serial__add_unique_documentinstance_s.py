...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DocumentInstance.serial'
        db.alter_column(u'mop_documentinstance', 'serial', self.gf('django.db.models.fields.CharField')(max_length=36, unique=True, null=True))
        # Adding unique constraint on 'DocumentInstance', fields ['serial']
        db.create_unique(u'mop_documentinstance', ['serial'])


        # Changing field 'TaskInstance.serial'
        db.alter_column(u'mop_taskinstance', 'serial', self.gf('django.db.models.fields.CharField')(max_length=32, unique=True, null=True))
        # Adding unique constraint on 'TaskInstance', fields ['serial']
        db.create_unique(u'mop_taskinstance', ['serial'])


    def backwards(self, orm):
        # Removing unique constraint on 'TaskInstance', fields ['serial']
        db.delete_unique(u'mop_taskinstance', ['serial'])

        # Removing unique constraint on 'DocumentInstance', fields ['serial']
        db.delete_unique(u'mop_documentinstance', ['serial'])


        # Changing field 'DocumentInstance.serial'
        db.alter_column(u'mop_documentinstance', 'serial', self.gf('django.db.models.fields.CharField')(max_length=36))

        # Changing field 'TaskInstance.serial'
        db.alter_column(u'mop_taskinstance', 'serial', self.gf('django.db.models.fields.CharField')(max_length=48))
    ...
    models = {
        u'assets.case': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'bc05866e-40ce-11e3-a295'", 'max_length': '36'})
        },
        u'assets.document': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'bc0561b5-40ce-11e3-b012'", 'max_length': '36'})
        },
        u'assets.mission': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'bbe7a30f-40ce-11e3-9893'", 'max_length': '50'})
        },
        u'assets.requisition': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
        ...
        u'assets.unit': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'max_length': '8'}),
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'bc06d833-40ce-11e3-8a5b'", 'max_length': '36'}),
        ...
        u'provmanager.provenance': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'bc06446e-40ce-11e3-9ee7'", 'max_length': '36'}),
