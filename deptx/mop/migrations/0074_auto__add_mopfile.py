...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MopFile'
        db.create_table(u'mop_mopfile', (
        ...
        db.send_create_signal(u'mop', ['MopFile'])


    def backwards(self, orm):
        # Deleting model 'MopFile'
        db.delete_table(u'mop_mopfile')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'3a85f597-6c03-11e3-8162'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
