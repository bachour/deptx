...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'WeekTracker'
        db.delete_table(u'mop_weektracker')

        # Adding model 'PerformanceTracker'
        db.create_table(u'mop_performancetracker', (
        ...
        db.send_create_signal(u'mop', ['PerformanceTracker'])


    def backwards(self, orm):
        # Adding model 'WeekTracker'
        db.create_table(u'mop_weektracker', (
            ('mop', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['players.Mop'])),
            ('modifiedAt', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('trust', self.gf('django.db.models.fields.IntegerField')(default=0)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'mop', ['WeekTracker'])

        # Deleting model 'PerformanceTracker'
        db.delete_table(u'mop_performancetracker')
    ...
    models = {
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'37c38ae3-4e12-11e3-91c3'", 'max_length': '36'}),
