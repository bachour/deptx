...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PerformancePeriod.reviewTime'
        db.add_column(u'mop_performanceperiod', 'reviewTime',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PerformancePeriod.reviewTime'
        db.delete_column(u'mop_performanceperiod', 'reviewTime')
    ...
    models = {
        ...
        u'mop.mail': {
            ...
            'sentAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 12, 0, 0)'}),
            'serial': ('django.db.models.fields.CharField', [], {'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            ...
            'trustInstance': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'4d636e17-6355-11e3-bad7'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
