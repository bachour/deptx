...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mop_trustinstance', (
            ...
            ('oldTrust', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('oldTotalTrust', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('newTrust', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('newTotalTrust', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
    ...
    models = {
        ...
        u'mop.trustinstance': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'mop': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['players.Mop']"}),
            'newTotalTrust': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'newTrust': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'oldTotalTrust': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'oldTrust': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        u'players.cron': {
            'Meta': {'object_name': 'Cron'},
            'activated': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'64942b75-df73-11e3-83b0'", 'max_length': '36'}),
