...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Mail.bodyData'
        db.delete_column(u'mop_mail', 'bodyData')

        # Adding field 'Mail.replyTo'
        db.add_column(u'mop_mail', 'replyTo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mop.Mail'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Mail.bodyData'
        db.add_column(u'mop_mail', 'bodyData',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Mail.replyTo'
        db.delete_column(u'mop_mail', 'replyTo_id')
    ...
    models = {
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'33bd7766-4d6b-11e3-95d9'", 'max_length': '36'}),
