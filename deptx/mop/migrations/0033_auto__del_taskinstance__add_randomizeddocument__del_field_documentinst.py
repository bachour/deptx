...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RandomizedDocument'
        db.create_table(u'mop_randomizeddocument', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('document', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.Document'])),
            ('provenance', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['provmanager.Provenance'], unique=True)),
            ('serial', self.gf('django.db.models.fields.CharField')(max_length=36, unique=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'mop', ['RandomizedDocument'])
        ...
        # Adding field 'DocumentInstance.status'
        db.add_column(u'mop_documentinstance', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DocumentInstance.type'
        db.add_column(u'mop_documentinstance', 'type',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DocumentInstance.randomizedDocument'
        db.add_column(u'mop_documentinstance', 'randomizedDocument',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mop.RandomizedDocument'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'mop_taskinstance', (
            ...
            ('provenance', self.gf('django.db.models.fields.related.OneToOneField')(related_name='taskInstance', unique=True, null=True, to=orm['provmanager.Provenance'], blank=True)),
            ('serial', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32, null=True, blank=True)),
        ...
        # Deleting model 'RandomizedDocument'
        db.delete_table(u'mop_randomizeddocument')
        ...
        db.add_column(u'mop_documentinstance', 'taskInstance',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='documentInstance', unique=True, null=True, to=orm['mop.TaskInstance'], blank=True),
                      keep_default=False)
        ...
        # Deleting field 'DocumentInstance.status'
        db.delete_column(u'mop_documentinstance', 'status')

        # Deleting field 'DocumentInstance.type'
        db.delete_column(u'mop_documentinstance', 'type')

        # Deleting field 'DocumentInstance.randomizedDocument'
        db.delete_column(u'mop_documentinstance', 'randomizedDocument_id')
    ...
    models = {
        ...
        u'mop.randomizeddocument': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'provenance': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['provmanager.Provenance']", 'unique': 'True'}),
            'serial': ('django.db.models.fields.CharField', [], {'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'1e6deeee-4ae9-11e3-ad58'", 'max_length': '36'}),
        ...
        u'provmanager.provenance': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'1e6d5de3-4ae9-11e3-96f5'", 'max_length': '36'}),
