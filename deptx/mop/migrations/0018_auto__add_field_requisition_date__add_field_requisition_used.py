...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Requisition.date'
        db.add_column(u'mop_requisition', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Requisition.used'
        db.add_column(u'mop_requisition', 'used',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Requisition.date'
        db.delete_column(u'mop_requisition', 'date')

        # Deleting field 'Requisition.used'
        db.delete_column(u'mop_requisition', 'used')
    ...
    models = {
        ...
        u'mop.taskstate': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mop': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['players.Mop']"}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'ca54c73a-e8b2-11e2-8a11-14109fe17ee1'", 'max_length': '36'}),
            'state': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
