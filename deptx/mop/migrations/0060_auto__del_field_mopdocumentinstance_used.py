...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MopDocumentInstance.used'
        db.delete_column(u'mop_mopdocumentinstance', 'used')


    def backwards(self, orm):
        # Adding field 'MopDocumentInstance.used'
        db.add_column(u'mop_mopdocumentinstance', 'used',
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'d1f70423-579a-11e3-97ef'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        u'players.mop': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'d1f5f0ab-579a-11e3-ae7c'", 'max_length': '36'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'}),
