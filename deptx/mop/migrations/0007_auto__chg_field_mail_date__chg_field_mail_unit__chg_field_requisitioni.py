...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Mail.date'
        db.alter_column(u'mop_mail', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Mail.unit'
        db.alter_column(u'mop_mail', 'unit_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.Unit'], null=True))

        # Changing field 'RequisitionInstance.date'
        db.alter_column(u'mop_requisitioninstance', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'Mail.date'
        db.alter_column(u'mop_mail', 'date', self.gf('django.db.models.fields.DateTimeField')())
        ...
        # Changing field 'RequisitionInstance.date'
        db.alter_column(u'mop_requisitioninstance', 'date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        u'assets.case': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'898d5b66-220c-11e3-b533-14109fe17ee1'", 'max_length': '36'})
        },
        u'assets.document': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'898e12fd-220c-11e3-ba4f-14109fe17ee1'", 'max_length': '36'}),
        ...
        u'assets.requisition': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'898e2dfa-220c-11e3-a3f4-14109fe17ee1'", 'max_length': '36'}),
        ...
        u'assets.task': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'898ddeb8-220c-11e3-9ac1-14109fe17ee1'", 'max_length': '36'}),
            'trust': ('django.db.models.fields.IntegerField', [], {'default': '25'}),
            'unit': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assets.Unit']"})
        },
        u'assets.unit': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'898d281c-220c-11e3-9536-14109fe17ee1'", 'max_length': '36'})
        },
        u'auth.group': {
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'898dc057-220c-11e3-96b2-14109fe17ee1'", 'max_length': '36'}),
        ...
        u'provmanager.provenance': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'898d8ac0-220c-11e3-ab4c-14109fe17ee1'", 'max_length': '36'}),
