...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentInstance.provenanceState'
        db.add_column(u'mop_documentinstance', 'provenanceState',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DocumentInstance.modified'
        db.add_column(u'mop_documentinstance', 'modified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DocumentInstance.correct'
        db.add_column(u'mop_documentinstance', 'correct',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentInstance.provenanceState'
        db.delete_column(u'mop_documentinstance', 'provenanceState')

        # Deleting field 'DocumentInstance.modified'
        db.delete_column(u'mop_documentinstance', 'modified')

        # Deleting field 'DocumentInstance.correct'
        db.delete_column(u'mop_documentinstance', 'correct')
    ...
    models = {
        u'assets.case': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'d228e568-1c95-11e3-86c1-14109fe17ee1'", 'max_length': '36'})
        },
        u'assets.document': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'d229c047-1c95-11e3-ad83-14109fe17ee1'", 'max_length': '36'}),
        ...
        u'assets.requisition': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'d22997ee-1c95-11e3-b833-14109fe17ee1'", 'max_length': '36'}),
        ...
        u'assets.task': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'d2293a5e-1c95-11e3-91c3-14109fe17ee1'", 'max_length': '36'}),
            'trust': ('django.db.models.fields.IntegerField', [], {'default': '25'}),
            'unit': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assets.Unit']"})
        },
        u'assets.unit': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'d228f511-1c95-11e3-b23c-14109fe17ee1'", 'max_length': '36'})
        },
        u'auth.group': {
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'d22a1b75-1c95-11e3-ae6a-14109fe17ee1'", 'max_length': '36'}),
        ...
        u'provmanager.provenance': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'d2294991-1c95-11e3-b3f1-14109fe17ee1'", 'max_length': '36'}),
