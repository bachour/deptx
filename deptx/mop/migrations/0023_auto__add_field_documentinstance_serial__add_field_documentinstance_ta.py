...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentInstance.serial'
        db.add_column(u'mop_documentinstance', 'serial',
                      self.gf('django.db.models.fields.CharField')(default='c596e194-31cb-11e3-ae1e', max_length=36),
                      keep_default=False)

        # Adding field 'DocumentInstance.taskInstance'
        db.add_column(u'mop_documentinstance', 'taskInstance',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='documentInstance', unique=True, null=True, to=orm['mop.TaskInstance']),
                      keep_default=False)


        # Changing field 'DocumentInstance.document'
        db.alter_column(u'mop_documentinstance', 'document_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.Document'], null=True))
        # Adding field 'TaskInstance.provenance'
        db.add_column(u'mop_taskinstance', 'provenance',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='taskInstance', unique=True, null=True, to=orm['provmanager.Provenance']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentInstance.serial'
        db.delete_column(u'mop_documentinstance', 'serial')

        # Deleting field 'DocumentInstance.taskInstance'
        db.delete_column(u'mop_documentinstance', 'taskInstance_id')


        # User chose to not deal with backwards NULL issues for 'DocumentInstance.document'
        raise RuntimeError("Cannot reverse this migration. 'DocumentInstance.document' and its values cannot be restored.")
        # Deleting field 'TaskInstance.provenance'
        db.delete_column(u'mop_taskinstance', 'provenance_id')
    ...
    models = {
        u'assets.case': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'dd78b738-31cb-11e3-907a'", 'max_length': '36'})
        },
        u'assets.document': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'dd791691-31cb-11e3-95da'", 'max_length': '36'})
        },
        u'assets.mission': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'c58a8e4f-31cb-11e3-bada'", 'max_length': '50'})
        },
        u'assets.requisition': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'dd77396b-31cb-11e3-9a59'", 'max_length': '36'}),
        ...
        u'mop.documentinstance': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'dd779702-31cb-11e3-8b10'", 'max_length': '36'}),
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'dd78872b-31cb-11e3-9ea6'", 'max_length': '36'}),
        ...
        u'provmanager.provenance': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'dd7773a8-31cb-11e3-a260'", 'max_length': '36'}),
