...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mail.tutorial'
        db.add_column(u'mop_mail', 'tutorial',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mail.tutorial'
        db.delete_column(u'mop_mail', 'tutorial')
    ...
    models = {
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'da09237d-5072-11e3-b8bd'", 'max_length': '36'}),
