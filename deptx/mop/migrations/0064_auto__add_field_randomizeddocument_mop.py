...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RandomizedDocument.mop'
        db.add_column(u'mop_randomizeddocument', 'mop',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['players.Mop'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RandomizedDocument.mop'
        db.delete_column(u'mop_randomizeddocument', 'mop_id')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'a343839e-5a85-11e3-b9ed'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
