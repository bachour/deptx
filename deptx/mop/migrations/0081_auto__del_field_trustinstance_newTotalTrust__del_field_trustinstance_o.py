...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TrustInstance.newTotalTrust'
        db.delete_column(u'mop_trustinstance', 'newTotalTrust')

        # Deleting field 'TrustInstance.oldTotalTrust'
        db.delete_column(u'mop_trustinstance', 'oldTotalTrust')

        # Adding field 'TrustInstance.totalTrust'
        db.add_column(u'mop_trustinstance', 'totalTrust',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TrustInstance.newTotalTrust'
        db.add_column(u'mop_trustinstance', 'newTotalTrust',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'TrustInstance.oldTotalTrust'
        db.add_column(u'mop_trustinstance', 'oldTotalTrust',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'TrustInstance.totalTrust'
        db.delete_column(u'mop_trustinstance', 'totalTrust')
    ...
    models = {
        ...
        u'mop.mail': {
            ...
            'sentAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 19, 0, 0)'}),
            'serial': ('django.db.models.fields.CharField', [], {'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'1b26f6ba-df75-11e3-b39e'", 'max_length': '36'}),
