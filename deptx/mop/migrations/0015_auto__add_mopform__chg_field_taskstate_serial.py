...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MopForm'
        db.create_table(u'mop_mopform', (
        ...
        db.send_create_signal(u'mop', ['MopForm'])


        # Changing field 'TaskState.serial'
        db.alter_column(u'mop_taskstate', 'serial', self.gf('django.db.models.fields.CharField')(max_length=36))

    def backwards(self, orm):
        # Deleting model 'MopForm'
        db.delete_table(u'mop_mopform')


        # Changing field 'TaskState.serial'
        db.alter_column(u'mop_taskstate', 'serial', self.gf('django.db.models.fields.CharField')(max_length=256))
    ...
    models = {
        ...
        u'mop.taskstate': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mop': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['players.Mop']"}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'2261284a-e8b0-11e2-a770-14109fe17ee1'", 'max_length': '36'}),
            'state': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
