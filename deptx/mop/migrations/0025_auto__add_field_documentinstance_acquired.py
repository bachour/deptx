...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentInstance.acquired'
        db.add_column(u'mop_documentinstance', 'acquired',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentInstance.acquired'
        db.delete_column(u'mop_documentinstance', 'acquired')
    ...
    models = {
        u'assets.case': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'a7c9b4d7-31d1-11e3-8fdf'", 'max_length': '36'})
        },
        u'assets.document': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'a7c8709e-31d1-11e3-90ab'", 'max_length': '36'})
        },
        u'assets.mission': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'a7aa97e1-31d1-11e3-852f'", 'max_length': '50'})
        },
        u'assets.requisition': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'a7ca91bd-31d1-11e3-8b54'", 'max_length': '36'}),
        ...
        u'mop.documentinstance': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'a7ca2e21-31d1-11e3-a01f'", 'max_length': '36'}),
        ...
        u'mop.taskinstance': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'a7c90f1c-31d1-11e3-8b6c'", 'max_length': '36'}),
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'a7c8aca1-31d1-11e3-ba75'", 'max_length': '36'}),
        ...
        u'provmanager.provenance': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'a7ca4e33-31d1-11e3-adc8'", 'max_length': '36'}),
