...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MopTracker.allowance'
        db.delete_column(u'mop_moptracker', 'allowance')

        # Adding field 'MopTracker.credit'
        db.add_column(u'mop_moptracker', 'credit',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'MopTracker.allowance'
        db.add_column(u'mop_moptracker', 'allowance',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'MopTracker.credit'
        db.delete_column(u'mop_moptracker', 'credit')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'fce1fe35-55d9-11e3-a903'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        u'players.mop': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'fce31321-55d9-11e3-a044'", 'max_length': '36'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'}),
