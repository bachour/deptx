...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrustTracker.tutorialProvErrors'
        db.add_column(u'mop_trusttracker', 'tutorialProvErrors',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrustTracker.tutorialProvErrors'
        db.delete_column(u'mop_trusttracker', 'tutorialProvErrors')
    ...
    models = {
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'be78a259-5078-11e3-b0f8'", 'max_length': '36'}),
