...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mop_trusttracker', (
            ...
            ('mop', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['players.Mop'], unique=True)),
    ...
    models = {
        ...
        u'mop.trusttracker': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'mop': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['players.Mop']", 'unique': 'True'}),
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'cb542402-4e18-11e3-9f51'", 'max_length': '36'}),
            'totalTrust': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'trust': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
