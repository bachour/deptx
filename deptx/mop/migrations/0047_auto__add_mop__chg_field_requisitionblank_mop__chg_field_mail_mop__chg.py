...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Mop'
        db.create_table(u'mop_mop', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cron', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cron.Cron'])),
            ...
            ('serial', self.gf('django.db.models.fields.CharField')(default='babf9c2e-4e14-11e3-a493', max_length=36)),
            ('totalTrust', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.send_create_signal(u'mop', ['Mop'])


        # Changing field 'RequisitionBlank.mop'
        db.alter_column(u'mop_requisitionblank', 'mop_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mop.Mop']))

        # Changing field 'Mail.mop'
        db.alter_column(u'mop_mail', 'mop_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mop.Mop']))

        # Changing field 'PerformanceTracker.mop'
        db.alter_column(u'mop_performancetracker', 'mop_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mop.Mop']))

        # Changing field 'MopDocumentInstance.mop'
        db.alter_column(u'mop_mopdocumentinstance', 'mop_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mop.Mop']))

        # Changing field 'Badge.mop'
        db.alter_column(u'mop_badge', 'mop_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mop.Mop']))

    def backwards(self, orm):
        # Deleting model 'Mop'
        db.delete_table(u'mop_mop')


        # Changing field 'RequisitionBlank.mop'
        db.alter_column(u'mop_requisitionblank', 'mop_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['players.Mop']))

        # Changing field 'Mail.mop'
        db.alter_column(u'mop_mail', 'mop_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['players.Mop']))

        # Changing field 'PerformanceTracker.mop'
        db.alter_column(u'mop_performancetracker', 'mop_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['players.Mop']))

        # Changing field 'MopDocumentInstance.mop'
        db.alter_column(u'mop_mopdocumentinstance', 'mop_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['players.Mop']))

        # Changing field 'Badge.mop'
        db.alter_column(u'mop_badge', 'mop_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['players.Mop']))
    ...
    models = {
        ...
        u'cron.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'bad583fd-4e14-11e3-a833'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        u'mop.badge': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'mop': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mop.Mop']"})
        },
        u'mop.mail': {
        ...
        u'mop.mop': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'bad5618a-4e14-11e3-a762'", 'max_length': '36'}),
        ...
        u'mop.performancetracker': {
            'Meta': {'object_name': 'PerformanceTracker'},
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'mop': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mop.Mop']"}),
