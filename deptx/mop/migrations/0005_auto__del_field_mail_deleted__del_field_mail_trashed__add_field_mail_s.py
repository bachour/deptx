...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Mail.deleted'
        db.delete_column(u'mop_mail', 'deleted')

        # Deleting field 'Mail.trashed'
        db.delete_column(u'mop_mail', 'trashed')
    ...
    def backwards(self, orm):
        # Adding field 'Mail.deleted'
        db.add_column(u'mop_mail', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Mail.trashed'
        db.add_column(u'mop_mail', 'trashed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    models = {
        ...
        u'mop.mail': {
            ...
            'receiver': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'receiver'", 'to': u"orm['players.Mop']"}),
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sender'", 'to': u"orm['players.Mop']"}),
