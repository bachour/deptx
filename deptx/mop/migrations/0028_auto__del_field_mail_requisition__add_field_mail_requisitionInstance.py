...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Mail.requisitionInstance'
        db.add_column(u'mop_mail', 'requisitionInstance',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Mail.requisitionInstance'
        db.delete_column(u'mop_mail', 'requisitionInstance_id')
    ...
    models = {
        ...
        u'assets.task': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'9b9d9eca-e98a-11e2-af2c-14109fe17ee1'", 'max_length': '36'}),
            'trust': ('django.db.models.fields.IntegerField', [], {'default': '25'}),
            'unit': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assets.Unit']"})
        },
        u'assets.unit': {
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'9b9d1a54-e98a-11e2-857d-14109fe17ee1'", 'max_length': '36'}),
