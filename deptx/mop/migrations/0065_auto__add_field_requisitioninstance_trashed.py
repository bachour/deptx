...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RequisitionInstance.trashed'
        db.add_column(u'mop_requisitioninstance', 'trashed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RequisitionInstance.trashed'
        db.delete_column(u'mop_requisitioninstance', 'trashed')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'7b25f423-5b60-11e3-9148'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
