...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Mail.trust'
        db.alter_column(u'mop_mail', 'trust', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Mail.trust'
        db.alter_column(u'mop_mail', 'trust', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'4e33c85c-4d63-11e3-bb94'", 'max_length': '36'}),
