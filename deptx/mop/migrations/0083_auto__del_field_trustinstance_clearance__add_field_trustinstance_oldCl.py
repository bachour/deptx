...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TrustInstance.oldClearance'
        db.add_column(u'mop_trustinstance', 'oldClearance',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'TrustInstance.newClearance'
        db.add_column(u'mop_trustinstance', 'newClearance',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'TrustInstance.oldClearance'
        db.delete_column(u'mop_trustinstance', 'oldClearance')

        # Deleting field 'TrustInstance.newClearance'
        db.delete_column(u'mop_trustinstance', 'newClearance')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'d5206051-e1e0-11e3-b126'", 'max_length': '36'}),
