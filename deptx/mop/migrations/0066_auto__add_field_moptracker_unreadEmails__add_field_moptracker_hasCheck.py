...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MopTracker.unreadEmails'
        db.add_column(u'mop_moptracker', 'unreadEmails',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'MopTracker.hasCheckedInbox'
        db.add_column(u'mop_moptracker', 'hasCheckedInbox',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MopTracker.unreadEmails'
        db.delete_column(u'mop_moptracker', 'unreadEmails')

        # Deleting field 'MopTracker.hasCheckedInbox'
        db.delete_column(u'mop_moptracker', 'hasCheckedInbox')
    ...
    models = {
        ...
        u'mop.mail': {
            ...
            'sentAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 3, 0, 0)'}),
            'serial': ('django.db.models.fields.CharField', [], {'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'1f343b14-5c17-11e3-9f6c'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
