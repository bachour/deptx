...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskState.serial'
        db.add_column(u'mop_taskstate', 'serial',
                      self.gf('django.db.models.fields.CharField')(default='95361c57-e8a9-11e2-9354-14109fe17ee1', max_length=256),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskState.serial'
        db.delete_column(u'mop_taskstate', 'serial')
    ...
    models = {
        ...
        u'mop.taskstate': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mop': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['players.Mop']"}),
            'serial': ('django.db.models.fields.CharField', [], {'default': "'953c11ba-e8a9-11e2-909b-14109fe17ee1'", 'max_length': '256'}),
            'state': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
