...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mail.needsReply'
        db.add_column(u'mop_mail', 'needsReply',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mail.needsReply'
        db.delete_column(u'mop_mail', 'needsReply')
    ...
    models = {
        ...
        u'mop.mail': {
            ...
            'sentAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 23, 0, 0)'}),
            'serial': ('django.db.models.fields.CharField', [], {'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'d0753ee6-b2d7-11e3-83d5'", 'max_length': '36'}),
