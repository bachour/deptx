...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PerformanceInstance.clearance'
        db.delete_column(u'mop_performanceinstance', 'clearance')

        # Adding field 'PerformanceInstance.performance'
        db.add_column(u'mop_performanceinstance', 'performance',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PerformanceInstance.result'
        db.add_column(u'mop_performanceinstance', 'result',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Mail.trustInstance'
        db.delete_column(u'mop_mail', 'trustInstance_id')

        # Adding field 'Mail.performanceInstance'
        db.add_column(u'mop_mail', 'performanceInstance',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mop.PerformanceInstance'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PerformanceInstance.clearance'
        db.add_column(u'mop_performanceinstance', 'clearance',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'PerformanceInstance.performance'
        db.delete_column(u'mop_performanceinstance', 'performance')

        # Deleting field 'PerformanceInstance.result'
        db.delete_column(u'mop_performanceinstance', 'result')

        # Adding field 'Mail.trustInstance'
        db.add_column(u'mop_mail', 'trustInstance',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mop.TrustInstance'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Mail.performanceInstance'
        db.delete_column(u'mop_mail', 'performanceInstance_id')
    ...
    models = {
        ...
        u'mop.mail': {
            ...
            'sentAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 11, 0, 0)'}),
            'serial': ('django.db.models.fields.CharField', [], {'max_length': '36', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'mop.performanceinstance': {
            ...
            'period': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['assets.PerformancePeriod']"}),
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'934ec9d4-628d-11e3-a063'", 'max_length': '36'}),
            'createdAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
