...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RandomizedDocument.active'
        db.add_column(u'mop_randomizeddocument', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RandomizedDocument.active'
        db.delete_column(u'mop_randomizeddocument', 'active')
    ...
    models = {
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'e114f068-4afe-11e3-bb76'", 'max_length': '36'}),
