...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RandomizedDocument.document'
        db.delete_column(u'mop_randomizeddocument', 'document_id')

        # Adding field 'RandomizedDocument.mopDocument'
        db.add_column(u'mop_randomizeddocument', 'mopDocument',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['assets.MopDocument']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'RandomizedDocument.document'
        raise RuntimeError("Cannot reverse this migration. 'RandomizedDocument.document' and its values cannot be restored.")
        # Deleting field 'RandomizedDocument.mopDocument'
        db.delete_column(u'mop_randomizeddocument', 'mopDocument_id')
    ...
    models = {
        ...
        u'players.mop': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'default': "'a5fc5828-4bb1-11e3-acf4'", 'max_length': '36'}),
