...
class MopDocumentInstance(models.Model):
    ...
    def getDocumentSerial(self):
        ...
        if self.type == self.TYPE_MOP:
            return self.randomizedDocument.mopDocument.serial
        else:
...
#     
#     def getTrust(self):
#         if self.getClearance() == Document.CLEARANCE_LOW:
#             return 0
#         elif self.getClearance() == Document.CLEARANCE_MEDIUM:
#             return 10
#         elif self.getClearance() == Document.CLEARANCE_HIGH:
#             return 20
#         else:
#             return 30
#     
