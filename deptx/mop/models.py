...
class TaskInstance(models.Model):
    ...
    serial = models.CharField(max_length=32, blank=True, null=True, help_text="leave blank, will be generated by system")
...
class DocumentInstance(models.Model):
    ...
    serial = models.CharField(max_length=36, blank=True, null=True, help_text="leave blank, will be generated by system")
