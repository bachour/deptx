...
var EDGE_COLOURS = { // use this to specify different colours for different edge types
		wasAssociatedWith:'gray',
		wasAttributedTo:'gray',
		used:'gray',
		wasDerivedFrom:'gray',
		wasGeneratedBy:'gray',
		actedOnBehalfOf:'gray',
		wasInformedBy:'gray',
		wasInfluencedBy:'gray',
		wasInvalidatedBy:'gray',
		wasStartedBy:'gray',
		wasEndedBy:'gray',
		alternateOf:'gray',
...
var EDGE_HIGHLIGHTED_COLOURS = {
		wasAssociatedWith:'yellow',
		wasAttributedTo:'yellow',
		used:'yellow',
		wasDerivedFrom:'yellow',
		wasGeneratedBy:'yellow',
		actedOnBehalfOf:'yellow',
		wasInformedBy:'yellow',
		wasInfluencedBy:'yellow',
		wasInvalidatedBy:'yellow',
		wasStartedBy:'yellow',
		wasEndedBy:'yellow',
		alternateOf:'yellow',
		specializationOf:'yellow',
		hadMember:'yellow'};
