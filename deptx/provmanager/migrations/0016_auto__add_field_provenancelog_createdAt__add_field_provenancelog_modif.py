...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProvenanceLog.createdAt'
        db.add_column(u'provmanager_provenancelog', 'createdAt',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'ProvenanceLog.modifiedAt'
        db.add_column(u'provmanager_provenancelog', 'modifiedAt',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Provenance.createdAt'
        db.add_column(u'provmanager_provenance', 'createdAt',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'Provenance.modifiedAt'
        db.add_column(u'provmanager_provenance', 'modifiedAt',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProvenanceLog.createdAt'
        db.delete_column(u'provmanager_provenancelog', 'createdAt')

        # Deleting field 'ProvenanceLog.modifiedAt'
        db.delete_column(u'provmanager_provenancelog', 'modifiedAt')

        # Adding field 'Provenance.date'
        db.add_column(u'provmanager_provenance', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 9, 25, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Deleting field 'Provenance.createdAt'
        db.delete_column(u'provmanager_provenance', 'createdAt')

        # Deleting field 'Provenance.modifiedAt'
        db.delete_column(u'provmanager_provenance', 'modifiedAt')
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'71a779b8-3121-11e3-94ae'", 'max_length': '36'}),
        ...
        u'provmanager.provenance': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'71a71dcf-3121-11e3-8f0a'", 'max_length': '36'}),
