...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProvenanceLog.cron'
        db.alter_column(u'provmanager_provenancelog', 'cron_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['players.Cron']))

    def backwards(self, orm):

        # Changing field 'ProvenanceLog.cron'
        db.alter_column(u'provmanager_provenancelog', 'cron_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cron.Cron']))
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'a50e9b2b-4e15-11e3-b1f3'", 'max_length': '36'}),
