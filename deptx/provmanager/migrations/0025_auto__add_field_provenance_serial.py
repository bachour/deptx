...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'provmanager_provenance', 'serial',
                      self.gf('django.db.models.fields.SlugField')(max_length=36, unique=True, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'bb348a05-4d75-11e3-b6ba'", 'max_length': '36'}),
