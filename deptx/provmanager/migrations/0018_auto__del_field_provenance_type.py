...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Provenance.type'
        db.delete_column(u'provmanager_provenance', 'type')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Provenance.type'
        raise RuntimeError("Cannot reverse this migration. 'Provenance.type' and its values cannot be restored.")
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'30b80614-359c-11e3-a81b'", 'max_length': '36'}),
        ...
        u'provmanager.provenance': {
            ...
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'30b7724c-359c-11e3-afe2'", 'max_length': '36'}),
