...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'provmanager_provenance', 'serial',
                      self.gf('django.db.models.fields.SlugField')(default='f81cbe66-3d8f-11e3-b04f', max_length=36),
                      keep_default=False)
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'0e191770-4af2-11e3-a781'", 'max_length': '36'}),
