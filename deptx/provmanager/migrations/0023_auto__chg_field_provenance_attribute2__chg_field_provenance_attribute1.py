...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Provenance.attribute2'
        db.alter_column(u'provmanager_provenance', 'attribute2', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Provenance.attribute1'
        db.alter_column(u'provmanager_provenance', 'attribute1', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        u'players.cron': {
            ...
            'activationCode': ('django.db.models.fields.CharField', [], {'default': "'f81c70d1-3d8f-11e3-8734'", 'max_length': '36'}),
        ...
        u'provmanager.provenance': {
            ...
            'modifiedAt': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'serial': ('django.db.models.fields.SlugField', [], {'default': "'f81cbe66-3d8f-11e3-b04f'", 'max_length': '36'}),
